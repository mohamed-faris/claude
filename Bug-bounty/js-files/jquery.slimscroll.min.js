            ...
            return this.each(function() {
                ...
                function r(e, t, i) {
                    ...
                    "scrollTo" in a && a.animate ? S.animate({
                        scrollTop: o
                    }) : S.scrollTop(o), S.trigger("slimscrolling", ~~o), n(), c()
                }
                ...
                function l() {
                    f = Math.max(S.outerHeight() / S[0].scrollHeight * S.outerHeight(), w), M.css({
                        height: f + "px"
                    });
                ...
                function c() {
                    a.alwaysVisible || (d = setTimeout(function() {
                        a.disableFadeOut && u || h || p || (M.fadeOut("slow"), H.fadeOut("slow"))
                    }, 1e3))
                }
                var u, h, p, d, g, f, v, b, m = "<div></div>",
                    w = 30,
                    y = !1,
                    S = e(this);
                if (S.css("-ms-touch-action", "none"), S.parent().hasClass(a.wrapperClass)) {
                    var x = S.scrollTop();
                    if (M = S.parent().find("." + a.barClass), H = S.parent().find("." + a.railClass), l(), e.isPlainObject(i)) {
                    ...
                    var E = e(m).addClass(a.wrapperClass).css({
                        position: "relative",
                        overflow: "hidden",
                        width: a.width,
                        height: a.height
                    ...
                    var H = e(m).addClass(a.railClass).css({
                            width: a.size,
                            height: "100%",
                            position: "absolute",
                            top: 0,
                    ...
                    H.css(D), M.css(D), S.wrap(E), S.parent().append(M), S.parent().append(H), a.railDraggable && M.bind("mousedown", function(i) {
                        var o = e(document);
                        return p = !0, t = parseFloat(M.css("top")), pageY = i.pageY, o.bind("mousemove.slimscroll", function(e) {
                    ...
                    }), window.navigator.msPointerEnabled && (S.bind("MSPointerDown", function(e) {
