(function(e) {
    function t(t) {
        for (var i, r, o = t[0], l = t[1], c = t[2], u = 0, p = []; u < o.length; u++) r = o[u], Object.prototype.hasOwnProperty.call(n, r) && n[r] && p.push(n[r][0]), n[r] = 0;
    ...
    "56d7": function(e, t, s) {
        ...
        var i = s("2b0e"),
            ...
            r = function() {
                ...
                return s("div", {
                    ...
                    staticClass: "title-results"
                }, [e._v(" search results ("), s("span", {
                    staticClass: "output-results"
                }, [e._v(e._s(e.totalResults) + " total")]), e._v(")")])] : [s("span", {
                    staticClass: "desktop-title"
                }, [e._v("Blocked recipients")]), s("span", {
                    staticClass: "mobile-title"
                }, [e._v("Suppressions")])]], 2), s("div", {
                    ...
                    ref: "searchBox"
                }), e.isMobile && e.canModifySuppressions ? s("AddSuppression", {
                    staticClass: "mobile-only"
                }) : e._e()], 1), s("SuppressionResultsDisplay", {
                ...
                }, [e.canModifySuppressions ? s("BlockButton", {
                    ref: "blockButton"
                }) : e._e()], 1)], 1), e.fullPageLoad ? s("AjaxLoadingSpinner") : e._e()], 1)
            },
            o = [],
            ...
            p = {
                methods: {
                    getUnixSecsRangeByDays: function(e, t) {
                        ...
                        var i = 0;
                        return void 0 !== t ? (e > 0 && (i = c.a.tz(s).subtract(e, "days").startOf("day").utc().unix()), {
                            start: i,
                            end: c.a.tz(s).endOf("day").utc().unix()
                        }) : (e > 0 && (i = c.a.utc().subtract(e, "days").startOf("day").unix()), {
                            start: i,
                            end: c.a.utc().endOf("day").unix()
                        })
                    },
            ...
            b = {
                ...
                created: function() {
                    this.makeRequest = function(e, t, s, i, n, a, r) {
                        void 0 !== r && null !== r || (r = !1);
                        var o = this;
                        f.a.ajax(END_POINTS.urls()[t] + "?action=" + encodeURIComponent(s) + "&CSRF_key=" + encodeURIComponent(HTML.csrfkey), {
                            method: e,
                            data: i,
            ...
            C = function() {
                ...
                }, [e.includeAddSuppression && !e.isMobile && e.canModify ? s("AddSuppression", {
            ...
            k = function() {
                ...
                return s("div", {
                    ...
                    on: {
                        click: e.triggerable_toggleOpened
                    }
                }, [e._v("\n    Export\n  ")]), s("ul", {
                    directives: [{
                        name: "show",
                    ...
                    staticClass: "dropdown-menu dropdown-options is-active mixin-triggerable-layer",
                    attrs: {
            ...
            w = [function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("li", {
                    staticClass: "desktop-hide optional-rows"
            ...
            x = (s("7f7f"), s("7514"), {
                ...
                created: function() {
                    f()(".page-content-wrapper .page-content").on("click.Bst", this.$_windowClicked), this.$eventBus.$on("mixin-triggerable-opened", this.$_opened)
                },
                mounted: function() {
                    var e = this;
                    this.layers = f()(this.$el).find(".mixin-triggerable-layer"), this.updateDevice(), window.addEventListener("resize", (function() {
                        e.updateDevice()
                    }))
                },
                destroyed: function() {
                    f()(window).off(".page-content-wrapper .page-content", this.$_windowClicked), this.$eventBus.$off("mixin-triggerable-opened", this.$_opened)
                },
                methods: {
                    $_windowClicked: function(e) {
                        for (var t = !1, s = 0; s < this.layers.length; ++s) {
                            var i = f()(this.layers[s]);
                            this.isOpen && (0 !== i.has(e.target).length || i.is(e.target)) && (t = !0)
                        }
                        this.isOpen != t && this.$_emitEvent(t), this.isOpen = t
                    },
                    $_opened: function(e) {
                        e === this.$options.name || "AllFilter" === this.$options.name && ("PeriodFilter" === e || "EventFilter" === e) ? (this.$eventBus.$emit("mixin-global-triggerable-opened"), this.isOpen = !0) : this.isOpen = !1
                    },
                    $_emitEvent: function(e) {
                        if (e) this.$eventBus.$emit("mixin-triggerable-opened", this.$options.name);
                        else {
                    ...
                    triggerable_toggleOpened: function(e) {
                        e.stopImmediatePropagation(), this.isOpen = !this.isOpen, this.$_emitEvent(this.isOpen)
                    },
                    triggerable_toggleClose: function(e) {
                        e.stopImmediatePropagation(), this.isOpen = !1, this.$_emitEvent(this.isOpen)
                    },
            ...
            j = {
                ...
                methods: {
                    ...
                    handleColumnToggle: function(e, t) {
                        ...
                        this.$set(this.shownColumns, t.id, !s), this.$set(t, "active", !s), this.$eventBus.$emit("mixin-column-has-changed")
                    },
                    downloadFile: function(e, t) {
                        f()(".notice.main.error").empty().removeClass("visible"), this.$eventBus.$emit("mixin-download-file-triggered", t), this.triggerable_toggleClose(e)
                    }
                },
                computed: {
                    shouldShow: function() {
                        return !!this.initialised || 0 === this.$store.state.runningAjaxRequests
                    },
            ...
            B = function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "drop-content add-suppression"
                }, [s("button", {
                    ...
                    staticClass: "block-toggle block-manual"
                }, [s("ul", [s("li", [s("h5", [e._v("Manually block a recipient")]), s("p", [e._v("Manually add a recipient email address or domain to block them from receiving any future emails.")])]), s("li", [s("div", {
                    staticClass: "email-add"
                }, [s("input", {
                    directives: [{
                        name: "model",
                        rawName: "v-model",
                    ...
                    on: {
                        input: function(t) {
                            t.target.composing || (e.addRecipient = t.target.value)
                        }
                    }
                }), s("input", {
                    directives: [{
                    ...
                    on: {
                        input: function(t) {
                            t.target.composing || (e.addDescription = t.target.value)
                        }
                    }
                }), s("input", {
            ...
            M = {
                ...
                methods: {
                    toggleBlock: function() {
                        this.manualBlock = !this.manualBlock, this.manualBlock ? f()("#dropdown-add-suppression").removeClass("is-block-csv") : f()("#dropdown-add-suppression").addClass("is-block-csv")
                    },
                    singleBlockClick: function(e) {
                        ...
                        this.mixinAjax_put(this.requestPoint, "add-suppression", s, (function(e) {
                    ...
                    csvBlockClick: function(e) {
                        ...
                        if ("csv" !== s.substring(s.length - 3, s.length)) return HTML.alertUser(HTML.alertType.error, "File must be a .csv."), !1;
                        var i = END_POINTS.urls()[this.requestPoint];
                        i += "?action=add-suppression-csv", i += "&CSRF_key=" + encodeURIComponent(HTML.csrfkey);
                        var n = new FormData;
                        ...
                        A.a.post(i, n, a).then((function(e) {
                            t.$store.commit("runningAjaxRequestsDecrement"), "OK" === e.data.status ? (t.showPopupAlert(e.data), t.$eventBus.$emit("mixin-search-has-changed"), t.$eventBus.$emit("mixin-search-trigger")) : HTML.handleError(e.data)
                        })).catch((function(e) {
                            t.$store.commit("runningAjaxRequestsDecrement");
                            var s = {};
                            s.error = "An unknown " + e + " occurred, please try again shortly.", HTML.handleError(s)
                        })), this.$store.commit("runningAjaxRequestsIncrement"), this.triggerable_toggleClose(e)
                    },
                    showPopupAlert: function(e) {
                        if (0 === e.invalid_emails.length && !e.invalid_header && 0 === e.duplicates_skipped && 0 === e.total_failed) return HTML.set_time(e), !1;
                        var t = HTML.alertType.success,
                            s = f()("<p></p>"),
                            i = e.number_of_emails_read - e.invalid_emails.length - e.total_failed;
                        if (e.invalid_header && i--, s.append(i + " email addresses added successfully."), e.total_failed > 0 && s.append(" " + e.total_failed + " already existed."), e.duplicates_skipped > 0) {
                            var n = this.getPluralWord(e.duplicates_skipped, "duplicate");
                            s.append(" " + e.duplicates_skipped + " " + n + " skipped.")
                        }
                        if (e.invalid_header && s.append(" 1 header row skipped."), e.invalid_emails.length > 0) {
                            s.append(" " + e.invalid_emails.length + " email addresses not added due to invalid format: </br>"), t = HTML.alertType.warning;
                            ...
                            if (r.addClass("used-by used-by-suppressions"), a.length > 0) {
                                ...
                                for (var c = f()("<span></span>").addClass("usedby-tooltip"), d = 0; d < a.length; d++) 0 != d && c.append(f()("<br>")), c.append(f()("<span></span>").text(a[d]));
                ...
                mounted: function() {
                    var e = this;
                    this.updateDevice(), window.addEventListener("resize", (function() {
                        e.updateDevice()
                    }))
                }
            },
            ...
            q = {
                ...
                methods: {
                    initTitleWithExport: function() {
                        this.$refs.exportButton.initExportButton(), this.initialised = !0
                    },
                    updateDevice: function() {
                        screen.width < 768 ? this.isMobile = !0 : this.isMobile = !1
                    }
            ...
            I = function() {
                ...
                return s("div", {
                    ...
                    staticClass: "form-control input-small input-inline mixin-triggerable-layer",
                    attrs: {
                        type: "search",
                    ...
                    return s("li", {
                    ...
                    }, [e._v(e._s(t.label) + ":")]), "hasAttachment" !== i ? s("input", {
                        directives: [{
                            name: "model",
                        ...
                        on: {
                            input: [function(s) {
                                s.target.composing || e.$set(t, "value", s.target.value.trim())
                            }, e.subSearchChanged],
                            keyup: e.isEnterTyped,
                            blur: function(t) {
                        ...
                        on: {
                            ...
                            change: function(s) {
                                ...
                                if (Array.isArray(i)) {
                                    var r = null,
                                        o = e._i(i, r);
                                    n.checked ? o < 0 && e.$set(t, "value", i.concat([r])) : o > -1 && e.$set(t, "value", i.slice(0, o).concat(i.slice(o + 1)))
            ...
            J = {
                ...
                methods: {
                    ...
                    forcePerformSearch: function(e) {
                        this.$eventBus.$emit("mixin-search-has-changed"), this.triggerable_toggleClose(e)
                    },
            ...
            V = function() {
                ...
                return e.shouldShow ? s("table", {
                    ...
                    staticClass: "checker",
                    on: {
                        click: e.allResultsClick
                    }
                }, [s("span", {
                    class: [{
                        checked: e.allResultsChecked
                    }, {
                        indeterminate: e.isSomeHighlighted
                    }]
                }, [s("input", {
                    attrs: {
                        type: "checkbox"
                ...
                })])]) : e._e()]) : e._e(), e._l(e.activeColumns, (function(t) {
                    return s("th", {
                        key: t.id,
                        class: {
                            "is-full-date": e.isFullDateInResults && "date_display" === t.id
                        },
                        attrs: {
                            id: "table-" + t.id
                        }
                    }, [e._v("\n        " + e._s(t.label) + "\n        "), "reason" === t.id && e.numSuppressions > 0 ? s("div", {
                        staticClass: "input-icon"
                    }, [s("i", {
                        directives: [{
                            name: "tooltip",
                            rawName: "v-tooltip.top",
                            value: "The suppression type: Hard Bounce, Spam, Unsubscribe or Manual.",
                            expression: "'The suppression type: Hard Bounce, Spam, Unsubscribe or Manual.'",
                            modifiers: {
                                top: !0
                            }
                        }],
                ...
                }))], 2)])])], 2)]), s("tbody", [e._l(e.suppressionResults, (function(t, i) {
                    return s("tr", {
                        ...
                        staticClass: "cell-record event-indicator"
                    }, ["compliance" !== t.reason && e.canModify ? s("div", {
                        staticClass: "checker",
                        on: {
                            click: function(s) {
                                return s.stopPropagation(), s.preventDefault(), e.resultClick(t)
                            }
                        }
                    }, [s("span", {
                        class: {
                    ...
                    })])]) : e._e()]), e._l(e.activeColumns, (function(i) {
                        return s("td", {
                            key: i.id,
                            class: ["cell-" + i.id, {
                                "cell-hidden": !e.activeColumnsWithData(i.id, t)
                            }],
                            on: {
                                click: function(t) {
                            ...
                            staticClass: "date",
                            class: {
                                hide: t[i.id].hideDate
                            }
                        }, [e._v("\n           " + e._s(t[i.id].date) + "Â \n         ")]), s("span", {
                            class: t[i.id].boldTime ? "time-large" : "time"
                        }, [e._v("\n           " + e._s(t[i.id].time) + "\n         ")])]) : "reason" === i.id ? s("span", {
                            staticClass: "long-event-indicator",
                            class: e.displayIconClass(t[i.id])
                        }) : "description" === i.id ? s("span", {
                            attrs: {
                                title: t.description
                            }
                        }, [e._v(e._s(t[i.id]))]) : s("span", [e._v(e._s(t[i.id]))])])
                    })), e.canModify ? s("td", {
                        staticClass: "table-action"
                    }, ["compliance" !== t.reason ? s("div", {
                        staticClass: "drop-content is-active suppression-delete-popup",
                        class: {
                    ...
                    }, [e._v("Ã—")]), t.displayDeletePopup ? s("ul", {
                        ...
                        on: {
                            click: function(s) {
                                return e.closeDeletePopUpClick(t)
                            }
                        }
                    }, [e._v("Cancel")])])]) : e._e()]) : e._e(), "compliance" === t.reason ? s("span", {
                        directives: [{
                            name: "tooltip",
                            rawName: "v-tooltip",
                            value: {
                                content: "This suppression was added by us, due to a direct complaint being made.",
                                classes: "not-deletable-popup"
                            },
                            expression: "{ content: 'This suppression was added by us, due to a direct complaint being made.', classes: 'not-deletable-popup'}"
                        }],
                        staticClass: "tooltip-type-link not-deletable"
                    }) : e._e()]) : e._e()], 2)
                })), e.requestActive && e.numSuppressions > 0 && e.$parent.showMoreLink ? s("tr", {
                    staticClass: "loading"
                }, [e._m(1)]) : e._e(), !e.requestActive && e.numSuppressions > 0 && e.$parent.showMoreLink ? s("tr", {
                    staticClass: "loading"
                }, [s("td", {
                    ...
                    on: {
                        click: e.loadMoreResults
                    }
                }, [e._v("Load More Results")])])]) : e._e(), e.requestActive || 0 != e.numSuppressions ? e._e() : s("tr", {
            ...
            X = [function() {
                var e = this,
                    t = e.$createElement,
                    s = e._self._c || t;
                return s("li", [s("p", [s("strong", [e._v("Display optional columns")]), s("br"), e._v("Choose to show optional columns (works best on large screens)")])])
            }, function() {
                var e = this,
                    t = e.$createElement,
                    s = e._self._c || t;
            ...
            ee = {
                ...
                created: function() {
                    this.$eventBus.$on("mixin-global-triggerable-opened", this.$_globalOpened), this.$eventBus.$on("mixin-global-triggerable-closed", this.$_globalClosed)
                },
                destroyed: function() {
                    this.$eventBus.$off("mixin-global-triggerable-opened", this.$_globalOpened), this.$eventBus.$off("mixin-global-triggerable-closed", this.$_globalClosed)
                },
                methods: {
            ...
            se = {
                ...
                methods: {
                    activeColumnsWithData: function(e, t) {
                        return t.hasOwnProperty(e) && void 0 !== t[e] && null !== t[e] && "" !== t[e]
                    },
                    ...
                    updateSuppressionResults: function(e, t) {
                        var s = this;
                        this.componentKey += 1, this.$nextTick((function() {
                            s.suppressionResults = e, s.shownColumns = t, s.displayColumns.forEach((function(e) {
                                var t = s.shownColumns[e.id];
                                !e.active && t && s.$set(e, "active", t)
                            })), s.addLongDescriptionClass(), s.highlightSearchTerm()
                        }))
                    },
                    handleColumnToggle: function(e, t) {
                        void 0 !== e && e.stopImmediatePropagation();
                    ...
                    allResultsClick: function() {
                        var e = this;
                        this.allResultsChecked = !this.allResultsChecked, this.suppressionResults.forEach((function(t) {
                    ...
                    performDeleteClick: function(e) {
                        ...
                        this.$set(e, "displayDeletePopup", !1), this.performDeleteSuppression(s)
                    },
                    ...
                    windowClicked: function(e) {
                        ...
                        screen.width < 768 && (t = ".suppression-result-wrapper"), f()(e.target).parents(t).length || this.hideAllDeletePopup()
                    },
                    ...
                    displayIconClass: function(e) {
                        return "compliance#suppression #bounce-dtable .not-deletable::after" === e ? "compliance" : "unsubscribe" === e ? "unsubscribed" : e
                    },
                    performDeleteSuppression: function(e) {
                        ...
                        var s = {
                            suppressions_to_delete: JSON.stringify(e)
                        };
                        this.mixinAjax_put(this.requestPoint, "delete", s, (function(e) {
                            HTML.set_time(e.responseJSON), t.$eventBus.$emit("mixin-search-has-changed"), t.$eventBus.$emit("mixin-search-trigger")
                        }), (function(e) {
                            HTML.handleError(e.responseJSON)
                        }))
                    ...
                    columnClick: function(e, t) {
                        if ("description" === t.id) {
                            void 0 !== e && screen.width < 768 && (e.preventDefault(), e.stopPropagation());
                    ...
                    addLongDescriptionClass: function() {
                        this.$nextTick((function() {
                            f()(".cell-description").each((function(e, t) {
                                f()(t).removeClass("long-description"), (t.offsetWidth < t.scrollWidth || t.offsetHeight > 20) && f()(t).addClass("long-description")
                            }))
                        }))
                    }
                },
                computed: {
                    ...
                    visibleClass: function() {
                        var e = "";
                        return this.columnFilters.forEach((function(t) {
                    ...
                    isFullDateInResults: function() {
                        var e = !1;
                        return this.suppressionResults.forEach((function(t) {
                ...
                mounted: function() {
                    ...
                    this.$eventBus.$on("remove-selected", (function() {
                        var t = e.suppressionResults.filter((function(e) {
                                return e.checked
                            })).map((function(e) {
                                var t = e.recipient,
                                    s = e.reason;
                    ...
                    })), f()(".page-content-wrapper .page-content").on("click.Bst", this.windowClicked)
                },
                destroyed: function() {
                    this.$eventBus.$off("remove-selected"), this.$eventBus.$off("deselect-all"), f()(window).off(".page-content-wrapper .page-content", this.windowClicked)
                }
            },
            ie = se,
            ...
            pe = function() {
                ...
                return s("div", {
                    ...
                    attrs: {
                        id: "block-button-wrapper"
                    }
                }, [e.displayConfirm ? e._e() : s("button", {
                    staticClass: "btn red button-outlined",
                    on: {
                        click: e.toggleRemoveStatus
                    }
                }, [e._v("Delete selected")]), e.displayConfirm ? e._e() : s("button", {
                    staticClass: "btn button-outlined",
                    on: {
                        click: e.deselectAll
                    }
                }, [e._v("Cancel")]), e.displayConfirm ? s("button", {
                    staticClass: "btn red button-outlined",
                    on: {
                        click: e.performRemoveSelected
                    }
                }, [e._v("Confirm delete")]) : e._e(), e.displayConfirm ? s("button", {
            ...
            be = function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "all-filter-wrapper indicator-bars"
                }, [s("div", {
                    ...
                    staticClass: "all-filter-icon"
                }), s("span", [e._v("Filters")]), s("i", {
                    staticClass: "fa fa-angle-down"
                })]), s("div", {
                    directives: [{
                        name: "show",
                    ...
                    staticClass: "dropdown-menu dropdown-options all-filter is-active mixin-triggerable-layer",
                    attrs: {
                        id: "all-filters"
                    }
                }, [e._m(0), s("PeriodFilter", {
                    ref: "periodFilter"
                }), s("EventFilter", {
                    ref: "eventFilter"
                })], 1)])])
            ...
            _e = [function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "all-filter-description"
                }, [s("p", [s("strong", [e._v("Filter results")]), s("br"), e._v("Refine scope of the results using the following criteria:")])])
            }],
            Ce = function() {
                var e = this,
                    t = e.$createElement,
                ...
                return s("div", {
                ...
                }, [e._v("Date range")]), s("span", {
                    staticClass: "mobile-hide"
                }, [e._v(e._s(e.getSelectedPeriod().prefix))]), e._v(e._s(e.getSelectedPeriod().label)), s("i", {
                    staticClass: "fa fa-angle-down"
                })]) : e._e(), s("ul", {
                    directives: [{
                        name: "show",
                    ...
                    }), e._v("\n                    " + e._s(t.prefix) + e._s(t.label) + "\n                ")]), "between" === t.id ? s("div", {
                        staticClass: "date-range"
                    }, [s("div", {
                        ref: "daterangeGroup",
                        refInFor: !0,
                        staticClass: "daterange-group"
                    }, [e._m(0, !0), e._m(1, !0)])]) : e._e()])
                })), s("li", {
                    staticClass: "dropdown-options-footer"
                }, [s("button", {
            ...
            ye = [function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "daterange-group__module daterange-group__module_custom"
                }, [s("div", {
                    staticClass: "daterange-group__from"
                }, [s("input", {
                    staticClass: "daterange-group__base-input daterange-group__date-input",
                    attrs: {
                        type: "text"
                    }
                }), s("div", {
                    staticClass: "daterange-group__time"
                }, [s("div", {
                    staticClass: "daterange-group__time-label"
                }, [s("span", {
                    staticClass: "daterange-group__time-icon"
                }), s("span", {
                    staticClass: "daterange-group__time-value"
                }, [s("span", {
                    ...
                    staticClass: "daterange-group__time-inputs"
                }, [s("input", {
                    staticClass: "daterange-group__base-input daterange-group__time-input daterange-group__time-input_hours",
                    attrs: {
                        type: "text",
                        pattern: "[0-9]"
                    }
                }), s("input", {
                    staticClass: "daterange-group__base-input daterange-group__time-input daterange-group__time-input_minutes",
                    attrs: {
                        type: "text",
                        pattern: "[0-9]"
                    }
                    ...
                    staticClass: "daterange-group__base-input daterange-group__time-input daterange-group__time-input_period daterange-group__time-select"
                }, [s("option", [e._v("AM")]), s("option", [e._v("PM")])])])])])]), s("div", {
                    staticClass: "daterange-group__between"
                }, [s("span", [e._v("â€“")])]), s("div", {
                    staticClass: "daterange-group__to"
                }, [s("input", {
                    staticClass: "daterange-group__base-input daterange-group__date-input",
                    attrs: {
                        type: "text"
                    ...
                    staticClass: "daterange-group__base-input daterange-group__time-input daterange-group__time-input_period daterange-group__time-select"
                }, [s("option", [e._v("AM")]), s("option", [e._v("PM")])])])])])]), s("button", {
                ...
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "daterange-group__module daterange-group__module_native"
                }, [s("div", {
                    staticClass: "daterange-group__from"
                }, [s("input", {
            ...
            ke = {
                ...
                methods: {
                    ...
                    periodChanged: function(e) {
                        var t = this;
                        if (this.$eventBus.$emit("mixin-search-has-changed"), this.datesToDisplay.forEach((function(e) {
                                t.$set(e, "checked", "")
                            })), this.$set(e, "checked", "checked"), "between" !== e.id) {
                            var s = e.days,
                                i = 0;
                            s > 0 && (i = c()().subtract(s, "days").toDate()), this.startDate = i, this.endDate = c()().toDate()
                        }
                        $("#period > li .radio span").removeClass("checked"), $("#period > li#" + e.id + " .radio span").addClass("checked")
                    },
                    getSelectedPeriod: function() {
                        var e = null;
                        return this.datesToDisplay.forEach((function(t) {
                            t.checked && (e = t)
                        })), e
                    },
                ...
                watch: {
                    ...
                    triggerable_isOpen: function(e) {
                        e || this.$daterangeGroup.data("daterangeGroup").hideTimeIfUnchanged()
                    }
                },
                mounted: function() {
                    var e = this;
                    Daterange.init(), this.$daterangeGroup = $(this.$refs.daterangeGroup[0]);
                    var t = this.$daterangeGroup.data("daterangeGroup");
                    this.startDate = c()().subtract(this.betweenConf.start, "days").startOf("day"), this.endDate = c()().subtract(this.betweenConf.end, "days").endOf("day"), t.setMaxDate(this.endDate), t.setStartDate(this.startDate), t.setEndDate(this.endDate), this.$daterangeGroup.on("change.daterangeGroup", (function() {
                        e.startDate = t.getStartDate(), e.endDate = t.getEndDate(), e.periodChanged(e.datesToDisplay.find((function(e) {
                            return "between" === e.id
                        })))
                    }))
                }
            ...
            Se = function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "event indicator-bars"
                }, [s("div", {
                    staticClass: "btn-group"
                }, [s("a", {
                    staticClass: "btn btn-default btn-icon-left",
                ...
                }, [e._v(e._s(e.selectedEventLabel))]), s("i", {
                    staticClass: "fa fa-angle-down"
                })]), s("ul", {
                    directives: [{
                        name: "show",
                    ...
                    staticClass: "dropdown-menu dropdown-options event-filter is-active mixin-triggerable-layer",
                    attrs: {
                        id: "filters"
                    }
                }, [e._m(0), s("li", {
                ...
                }, [e._v(e._s(e.checkboxLabel))])])]), e._l(e.eventsToDisplay, (function(t) {
                    return s("li", {
                        key: t.id,
            ...
            je = [function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("li", {
                    staticClass: "event-filter-description"
                }, [s("p", [s("strong", [e._v("Filter by event")]), s("br"), e._v("Only show these events:")])])
            }],
            De = {
                name: "EventFilter",
                mixins: [S, h],
                data: function() {
                    return {
                        eventsToDisplay: this.$config.eventsToDisplay
                    }
                },
                methods: {
                    allEventsClick: function() {
                        this.$eventBus.$emit("mixin-search-has-changed");
                        var e = "";
                        this.allEventsCheckedStatus || (e = "checked"), this.updateEventsCheckStatus(e)
                    },
                    eventClick: function(e) {
                        this.$eventBus.$emit("mixin-search-has-changed"), e.active ? this.$set(e, "active", !1) : this.$set(e, "active", !0)
                    },
                    ...
                    getSelectedEvents: function() {
                        var e = this.eventsToDisplay.filter((function(e) {
                            return e.active
                        })).map((function(e) {
                            return e.backendId
                        }));
                        return 0 === e.length && (this.updateEventsCheckStatus(!0), e = this.eventsToDisplay.filter((function(e) {
                            return e.active
                        })).map((function(e) {
                            return e.backendId
                        }))), e
                ...
                computed: {
                    checkboxLabel: function() {
                        return this.checkedEvents.length === this.eventsToDisplay.length || this.checkedEvents.length > 0 ? "Deselect All" : "Select All"
                    },
                    ...
                    allEventsCheckedStatus: function() {
                        return this.checkedEvents.length === this.eventsToDisplay.length ? "checked" : this.checkedEvents.length > 0 ? "indeterminate" : ""
                    },
                    selectedEventLabel: function() {
                        return this.checkedEvents.length === this.eventsToDisplay.length ? "All" : this.checkedEvents.length > 1 ? "Multiple" : 1 === this.checkedEvents.length ? this.checkedEvents[0].label : "None"
                    }
                }
            },
            Oe = De,
            ...
            Me = function() {
                ...
                return s("div", {
                    ...
                    staticClass: "icon-user-special"
                }, [s("span", {
                    staticClass: "icon-user-count"
                }, [e._v(e._s(e.userCount()) + "Â ")])]), s("span", {
                ...
                }, [s("li", ["Webhooks" === e.requestPoint ? s("p", [s("strong", [e._v("Filter by user")]), s("br"), e._v("Receive events for only these users:\n        ")]) : e._e(), "peruser_userdrop" === e.requestPoint ? s("p", [s("strong", [e._v("Filter by user")]), s("br"), e._v("Users are shown in descending order:\n        ")]) : e._e(), "Webhooks" === e.requestPoint && "Webhooks" !== e.requestPoint ? s("p", [s("strong", [e._v("Filter by user")]), s("br"), e._v("Only show these users:\n        ")]) : e._e(), s("span", {
                    staticClass: "dropdown-menu-close desktop-hide",
                    on: {
                        click: e.triggerable_toggleClose
                    }
                }, [e._v("Ã—")])]), "peruser_userdrop" !== e.requestPoint ? s("li", {
                    staticClass: "list-item-bleed"
                }, [s("span", {
                    staticClass: "icon-search-dark"
                }), s("input", {
                    directives: [{
                        name: "model",
                        rawName: "v-model",
                    ...
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: e.displayableUsernames().length > 1 || e.topUsernames.length > 1,
                        expression: "displayableUsernames().length > 1 || topUsernames.length > 1"
                    }],
                    staticClass: "users-filter users-toggle-all",
                    on: {
                        click: e.allUsersClick
                    }
                }, [s("div", {
                    staticClass: "filter-toggler users-filter-toggler default"
                }, [s("div", {
                    staticClass: "checker"
                }, [s("span", {
                    staticClass: "checker-box",
                    ...
                    staticClass: "indicator-copy toggle-copy"
                }, [e._v(e._s(e.allCheckDisplay()))])])]), s("li", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: 0 == e.displayableUsernames().length && 0 == e.topUsernames.length,
                        expression: "displayableUsernames().length == 0 && topUsernames.length == 0"
                    }]
                }, [s("span", {
                    staticClass: "indicator-copy toggle-copy",
                    staticStyle: {
                ...
                }, [e._v("No matching usernames")])]), s("li", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: e.displayableUsernames().length > 0 || e.topUsernames.length > 0,
                        expression: "displayableUsernames().length > 0 || topUsernames.length > 0"
                    }]
                }, [s("ul", {
                    ...
                    return s("li", {
                        key: t.username,
                        staticClass: "users-filter"
                    }, [s("div", {
                        staticClass: "filter-toggler users-filter-toggler",
                        on: {
                            click: function(s) {
                    ...
                    return s("li", {
                        ...
                        domProps: {
                            innerHTML: e._s(void 0 !== t.matchLabel ? t.matchLabel : t.label)
                        }
                    })])])])
                }))], 2)]), s("li", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: "peruser_userdrop" == e.requestPoint && e.displayPaging,
                        expression: "requestPoint == 'peruser_userdrop' && displayPaging"
                    }],
            ...
            Fe = [function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "load-users prev-users"
                }, [s("a", {
                ...
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "load-users next-users"
                }, [s("a", {
            ...
            Ue = (s("3b2b"), s("4917"), {
                ...
                methods: {
                    initUsernames: function() {
                        this.updateUserCheckStatus("checked"), this.updateUserDisplayStatus()
                    },
                    ...
                    userDisplayStatusChange: function() {
                        this.$eventBus.$emit("mixin-search-has-changed"), this.updateUserDisplayStatus()
                    },
                    updateUserDisplayStatus: function() {
                        ...
                        this.usernames.forEach((function(i) {
                            ...
                            i.matchLabel = void 0, "" === t ? e.$set(i, "display", !0) : n ? (e.$set(i, "display", !0), i.matchLabel = i.label.replace(s, '<strong class="query-match">$1</strong>')) : e.$set(i, "display", !1)
                        }))
                    },
                    getSearchRegex: function(e) {
                        var t = null;
                        return "" !== e && e.length > 0 && (t = new RegExp("(" + e + ")", "gi")), t
                    },
                    getUsersForSearch: function() {
                        var e = [];
                        return this.isAllUsersChecked() || (e = this.getCheckedUsers(), 0 === e.length && (this.updateUserCheckStatus("checked"), this.searchKeyword = "", this.updateUserDisplayStatus())), e
                    },
                    getCheckedUsers: function() {
                        var e = [];
                        return this.usernames.forEach((function(t) {
                            t.checked && t.display && e.push(t.username)
                        })), e
                    },
                    isAllUsersChecked: function() {
                        var e = !0;
                        return !this.usernames.length > 0 || this.usernames.forEach((function(t) {
                    ...
                    precacheUsernames: function() {
                        ...
                        if (!this.initialised) {
                            ...
                            HTML.clearError(s), this.mixinAjax_get(this.requestPoint, "load-usernames", null, (function(t) {
                                e.initialised = !0, e.usernames = e.escapeUsernamesHtml(t.responseJSON.results.usernames), e.initUsernames()
                            }), (function(e) {
                                HTML.handleError(Object.assign(e.responseJSON, {
                                    errorID: s
                                }))
                            }), t)
                        }
                    ...
                    allUsersCheckedStatus: function() {
                        return this.isAllUsersChecked() ? "checked" : this.partiallyChecked() ? "indeterminate" : ""
                    },
                    ...
                    userClick: function(e, t) {
                        void 0 !== e && e.stopImmediatePropagation(), this.$eventBus.$emit("mixin-search-has-changed"), t.checked ? this.$set(t, "checked", "") : this.$set(t, "checked", "checked")
                    },
                    allUsersClick: function() {
                        this.$eventBus.$emit("mixin-search-has-changed");
                        var e = "";
                        this.allUsersCheckedStatus() || (e = "checked"), this.updateUserCheckStatus(e)
                    },
                    initUserFilter: function() {
                        this.precacheUsernames()
                    },
                    allCheckDisplay: function() {
                        return this.allUsersCheckedStatus() ? "Deselect All" : "Select All"
                    },
                    ...
                    escapeUsernamesHtml: function(e) {
                        ...
                        return e.forEach((function(e) {
                            e.label = t.escapeHtml(e.label), e.username = t.escapeHtml(e.username)
                        })), e
                    },
            ...
            ze = {
                ...
                methods: {
                    initSuppression: function(e, t, s) {
                        this.actingRole = s, this.clientTimezone = t, void 0 !== t && null !== t && "" !== t || (this.clientTimezone = c.a.tz.guess()), this.shownColumns = {
                            description: void 0 !== e.app_settings && e.app_settings.show_suppressions_reason_col,
                            email_subject: void 0 !== e.app_settings && e.app_settings.show_suppressions_subject_col
                        }, setTimeout(this.holdInit, 100)
                    },
                    holdInit: function() {
                        this.initialised || void 0 == HTML.csrfkey || (this.initComponents(), this.loadSuppression())
                    },
                    initComponents: function() {
                        this.$refs.allFilter.$refs.periodFilter.initPeriodFilter(), this.$refs.searchBox.initSearchBox(), this.$refs.userFilter.initUserFilter(), this.$refs.suppressionResultsDisplay.initSuppressionResultsDisplay(), this.$refs.titleWithExport.initTitleWithExport()
                    },
                    ...
                    buildSearchPayload: function(e) {
                        ...
                        if ("between" !== s.id) t = this.getUnixSecsRangeByDays(s.days, this.clientTimezone);
                        else {
                            var i = this.$refs.allFilter.$refs.periodFilter.getSelectedBetweenFrom(),
                                n = this.$refs.allFilter.$refs.periodFilter.getSelectedBetweenTo();
                        ...
                        var a = {
                            ...
                            shown_events: this.$refs.allFilter.$refs.eventFilter.getSelectedEvents(),
                            continue_token: "",
                            file_type: this.fileType
                        };
                        return a.search_usernames = this.$refs.userFilter.getUsersForSearch(), console.log(this.$refs.userFilter.getUsersForSearch()), this.loadMoreSearchPayload = a, a
                    },
                    handleTableResults: function(e) {
                        var t = this;
                        this.clearTableOnResults && (this.tableRows = [], this.clearTableOnResults = !1), this.datestamp_format = e.datestamp_format, this.totalResults = e.metadata.records_returned.toLocaleString(), this.searchTerm = this.requestedSearchTerm, this.showMoreLink = !!e.metadata.continue_token, e.suppressions.forEach((function(e) {
                            e["date_display"] = t.convertUnixTS(e.timestamp), e["reason"] = e["reason"].replace("bounce", "hard-bounced")
                        })), this.tableRows = this.tableRows.concat(e.suppressions), this.continueToken = e.metadata.continue_token
                    },
                    updateSuppressionData: function() {
                        this.$refs.suppressionResultsDisplay.updateSuppressionResults(this.tableRows, this.shownColumns), this.$refs.titleWithExport.$refs.exportButton.updateShownColumns(this.shownColumns)
                    },
                    performSearch: function(e, t) {
                        ...
                        this.requestedSearchTerm = i.recipient_search, this.mixinAjax_get(this.requestPoint, "", i, (function(t) {
                            s.handleTableResults(t.responseJSON.results), e && (s.initialised = !0), s.$nextTick((function() {
                    ...
                    saveColumn: function() {
                        ...
                        var t = !0;
                        this.mixinAjax_put(this.requestPoint, "save-columns", this.buildSearchPayload(), (function() {
                            e.columnIsSaving = !1
                        }), (function() {
                            e.columnIsSaving = !1
                        }), t)
                    ...
                    performDownloadFile: function(e) {
                        this.fileType = e, this.mixinAjax_put(this.requestPoint, "download-file", this.buildSearchPayload(), (function(e) {
                            HTML.set_time(e.responseJSON), window.location.replace(e.responseJSON.results.stream_url)
                        }), (function(e) {
                            HTML.handleError(e.responseJSON)
                        }))
                    },
                    convertUnixTS: function(e) {
                        var t = {
                            ...
                            n = s.format("ddd, MMM Do, YYYY") + " at " + s.format("h:mm:ss A zz");
                        t.title = n, t.date = i.slice(0, i.indexOf(" ")), t.time = i.slice(i.indexOf(" ") + 1);
                        var a = c.a.tz(this.clientTimezone);
                        return s.format("DDMMYYYY") === a.format("DDMMYYYY") && (t.hideDate = !0, t.boldTime = !0), t
                    },
                    updateBlockButtonLocation: function() {
                        var e = document.querySelector(".dataTables_wrapper"),
                            t = this.getWindowWidth() < 768 ? 112 : 63;
                        window.innerHeight + window.scrollY + t >= document.body.offsetHeight ? (this.isBottomOfPage = !0, e.classList.remove("bottom-fixed")) : this.isBottomOfPage && window.innerHeight + window.scrollY + t < document.body.offsetHeight && (this.isBottomOfPage = !1, e.classList.add("bottom-fixed"))
                    },
                ...
                mounted: function() {
                    var e = this;
                    this.updateDevice(), this.updateBlockButtonLocation(), window.addEventListener("resize", (function() {
                        e.updateDevice()
                    }))
                },
                created: function() {
            ...
            Je = {
                ...
                computed: {},
                mounted: function() {
                    this.$refs.suppression.initSuppression(this.apMetadata, this.clientTimezone, this.actingRole)
                }
            },
            Ke = Je,
        ...
        var Xe = new Ve["a"].Store({
            ...
            Ze = s("e53f"),
            Qe = s("e37d");
        i["a"].directive("tooltip", Qe["c"]), i["a"].directive("close-popover", Qe["a"]), i["a"].component("v-popover", Qe["b"]), i["a"].config.productionTip = !1, i["a"].prototype.$eventBus = new i["a"], i["a"].prototype.$config = Ze, new i["a"]({
            store: Xe,
            render: function(e) {
                return e(Ye)
            }
