    ...
    ! function(e, i) {
        ...
        return n = function() {
            function t(t, i) {
                ...
                }(this)), this.$container = this.$element.wrap(this.$container).parent(), this.$wrapper = this.$container.wrap(this.$wrapper).parent(), this.$element.before(this.options.inverse ? this.$off : this.$on).before(this.$label).before(this.options.inverse ? this.$on : this.$off), this.options.indeterminate && this.$element.prop("indeterminate", !0), this._initWidth(), this._containerPosition(this.options.state, function(t) {
                    return function() {
            ...
            return t.prototype._constructor = t, t.prototype.state = function(t, e) {
                ...
                var t;
                return this.$wrapper.is(":visible") ? this._width() : t = i.setInterval(function(e) {
                    return function() {
                        return e.$wrapper.is(":visible") ? (e._width(), i.clearInterval(t)) : void 0
                    }
                }(this), 50)
                ...
                }(this)), i ? e.support.transition ? this.$container.one("bsTransitionEnd", i).emulateTransitionEnd(500) : i() : void 0
            ...
            return s = arguments[0], i = 2 <= arguments.length ? t.call(arguments, 1) : [], o = this, this.each(function() {
                var t, a;
                return t = e(this), a = t.data("bootstrap-switch"), a || t.data("bootstrap-switch", a = new n(this, s)), "string" == typeof s ? o = a[s].apply(a, i) : void 0
            }), o
