...
(() => {
    ...
    var Y = (r, i, t) => {
        ...
        return i.className = `pointer pointer-${t}`, i.addEventListener("keydown", c), i.addEventListener("click", h), {
            $pointer: i,
            get percent() {
                return n
            },
            ...
            return (() => {
                for (let c of $e) {
                    ...
                    for (let P of L) try {
                        let A = P[0],
                            k = P[1];
                        Object.prototype.hasOwnProperty.call(r, A) || Object.defineProperty(r, A, {
                            get() {
                                return C(h, k)
                            },
                            set: F => {
    ...
    var rt = 0,
        ...
        wn = (r, i, t) => {
            let n = t.map(e => e[0]),
                ...
                z = e => {
                    ...
                    if (b === I) {
                        let {
                            height: y,
                            top: M
                        } = i.getBoundingClientRect(), v = e.type.indexOf("mouse") !== -1 ? e.clientY : e.touches[0].clientY;
                        o = Math.min(Math.max(0, v - M), y) * 100 / y
                    } else {
                        let {
                            width: y,
                            left: M
                        } = i.getBoundingClientRect(), v = e.type.indexOf("mouse") !== -1 ? e.clientX : e.touches[0].clientX;
                        o = Math.min(Math.max(0, v - M), y) * 100 / y
                    }
                ...
                yt = e => {
                    F = e, F ? document.removeEventListener("wheel", Q) : document.addEventListener("wheel", Q, {
                        passive: !1
                    })
                },
                Xe = e => {
            ...
            return (() => {
                ...
                e && (d = _t(e)), Ge(r.getAttribute(he)), Ye(D(r.getAttribute(ye))), Ze(D(r.getAttribute(xe))), Nn(r.getAttribute(be), r.getAttribute(ge)), ie(r.getAttribute(fe)), Xe(r.getAttribute(pe)), ht(t.map(y => y[1])), We(D(r.getAttribute(le))), Ke(E(r.getAttribute(ue), 0)), je(E(r.getAttribute(de), 1 / 0)), oe(D(r.getAttribute(ce))), Je(E(r.getAttribute(me), U)), Un(), zn(), m = xn(r, i, n), xt((u = r.getAttribute(Te)) != null ? u : Mn), i.addEventListener("mousedown", st), i.addEventListener("mouseup", J), i.addEventListener("touchmove", z), i.addEventListener("touchstart", z), F || document.addEventListener("wheel", Q, {
                    passive: !1
                }), l = Pn(r, Hn, {
                    setValues: ht,
                    setMin: te,
    ...
    var Dn = (r, i, t) => {
        ...
        if (n && r.styles) {
            let [l, a, f, x] = n, p = i.replace(/\D/g, "").trim(), b = p === "" || p === "0" || p === "1" ? 0 : E(p, 0) - 1;
    ...
    var it = class extends HTMLElement {
            ...
            connectedCallback() {
                ...
                if (!n) return;
                let s = Sn(this, t);
                this.slider = wn(this, n, s), Tn(this, this.slider), this._observer = new MutationObserver(l => {
                    l.forEach(a => {
                        var x;
