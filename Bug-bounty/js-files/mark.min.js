                ...
                value: function(e) {
                    ...
                    switch (o.forEach(function(e) {
                        ...
                        default:
                            return "()(".concat(e, ")");
                        case "complementary":
                            return i = "\\s" + (i || this.escapeStr("!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~隆驴")), "()([^".concat(i, "]*").concat(e, "[^").concat(i, "]*)");
                        case "exactly":
