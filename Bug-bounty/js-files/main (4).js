(function(t) {
    function e(e) {
        for (var s, o, r = e[0], c = e[1], l = e[2], _ = 0, d = []; _ < r.length; _++) o = r[_], Object.prototype.hasOwnProperty.call(a, o) && a[o] && d.push(a[o][0]), a[o] = 0;
    ...
    "56d7": function(t, e, i) {
        ...
        var s, a, n = i("2b0e"),
            ...
            c = function() {
                ...
                return e("div", {
                    ...
                    staticClass: "info-splash { 'smtpauth-splash-on': isSplashVisible }"
                }, [t._m(0), e("h2", {
                    staticClass: "splash-block-500"
                }, [t._v("\n      API Keys allow you to integrate SMTP2GO with your other software.\n    ")]), e("p", {
                    staticClass: "lead-in splash-block-500"
        ...
        var p, m, f, h = {
            ...
            b = (s = {}, Object(u["a"])(s, h.getters.IS_AJAX_RUNNING, (function(t) {
            ...
            v = (a = {}, Object(u["a"])(a, h.mutations.SET_CSRF_KEY, (function(t, e) {
                t.csrf_key = e
        ...
        var k = (p = {}, Object(u["a"])(p, P.getters.GET_IS_COLUMN_SHOWN, (function(t) {
                return function(e) {
                    if (t.app_settings["apiauth_automatic_cols"]) return t.automatic_cols[e];
                ...
                return null === t.generatedKeyData ? {
                    key: ""
                } : t.generatedKeyData
            ...
            })), Object(u["a"])(p, P.getters.IS_FETCHING_MORE_ACTIVE_USERS, (function(t) {
                ...
                return function(e) {
                    var i = null;
                    return "default" === e ? null != t.default_ippool_label && "" != t.default_ippool_label ? "Use default (" + t.default_ippool_label + ")" : "Use default" : (void 0 !== e && null !== e && t.ip_pools.forEach((function(t) {
                        t.id === e && (i = t.label)
                    })), i)
                }
            ...
            })), Object(u["a"])(p, P.getters.EDIT_MODAL_BOUNCE_NOTIFICATIONS, (function(t) {
                ...
                return null !== t.editModalData && void 0 !== t.editModalData._hash && null !== t.editModalData._hash ? t.editModalData._hash : ""
            })), Object(u["a"])(p, P.getters.EDIT_MODAL_ENDPOINTS, (function(t) {
                return null !== t.editModalData && void 0 !== t.editModalData.endpoints && null !== t.editModalData.endpoints ? t.editModalData.endpoints : []
            ...
            U = (m = {}, Object(u["a"])(m, P.mutations.SET_GENERATED_KEY_DATA, (function(t, e) {
                t.generatedKeyData = e
            })), Object(u["a"])(m, P.mutations.SET_IS_API_ONLINE, (function(t, e) {
                t.apiOnline = e
            })), Object(u["a"])(m, P.mutations.SET_SHOW_PASSWORD_ON_MODAL, (function(t, e) {
                ...
                var i = "show_apiauth_" + e + "_col";
                n["a"].set(t.app_settings, i, !t.app_settings[i]), t.columns_need_saving = !0
            })), Object(u["a"])(m, P.mutations.SET_IS_AUTOMATIC_COLS, (function(t, e) {
                n["a"].set(t.app_settings, "apiauth_automatic_cols", e), !1 === e && (null === t.app_settings["show_apiauth_description_col"] && (t.app_settings["show_apiauth_description_col"] = t.automatic_cols["description"]), null === t.app_settings["show_apiauth_ippool_col"] && (t.app_settings["show_apiauth_ippool_col"] = t.automatic_cols["ippool"]), null === t.app_settings["show_apiauth_unsubscribes_col"] && (t.app_settings["show_apiauth_unsubscribes_col"] = t.automatic_cols["unsubscribes"]), null === t.app_settings["show_apiauth_ratelimit_col"] && (t.app_settings["show_apiauth_ratelimit_col"] = t.automatic_cols["ratelimit"]), null === t.app_settings["show_apiauth_archiving_col"] && (t.app_settings["show_apiauth_archiving_col"] = t.automatic_cols["archiving"]), null === t.app_settings["show_apiauth_open_tracking_col"] && (t.app_settings["show_apiauth_open_tracking_col"] = t.automatic_cols["open_tracking"]), null === t.app_settings["show_apiauth_click_tracking_col"] && (t.app_settings["show_apiauth_click_tracking_col"] = t.automatic_cols["click_tracking"])), t.columns_need_saving = !0
                ...
                i.push.apply(i, Object(A["a"])(e)), t.active_users = i.sort((function(t, e) {
                    return R(t, e)
                })), w(t)
            ...
            })), Object(u["a"])(m, P.mutations.SET_IS_FETCHING_ACTIVE_USERS, (function(t, e) {
                t.isFetchingActiveUsers = e
            })), Object(u["a"])(m, P.mutations.SET_IS_FETCHING_MORE_ACTIVE_USERS, (function(t, e) {
                t.isFetchingMoreActiveUsers = e
            })), Object(u["a"])(m, P.mutations.SET_API_NOTIFICATION_SEEN, (function(t, e) {
                t.apiNotificationSeen = e
            })), Object(u["a"])(m, P.mutations.SET_ACTIVE_USER_PROPERTY, (function(t, e) {
                var i = e.active_user,
                    s = e.key,
                    a = e.value;
                n["a"].set(i, s, a)
                ...
                t.active_users.forEach((function(e, o) {
                    if (e.password === i) return n["a"].set(t.active_users, o, s), void(a = !0)
                })), a || n["a"].set(t.active_users, t.active_users.length, s), t.active_users = t.active_users.sort((function(t, e) {
                    return R(t, e)
                })), w(t)
            })), Object(u["a"])(m, P.mutations.TOGGLE_EDIT_MODAL, (function(t, e) {
                var s = e.visible,
                    a = e.data;
                if (t.isEditModalShowing = s, s && null !== a && void 0 !== a) a.old_username = a.username, a.is_editing = !0, a.archiving_initial = a.archiving, console.log("EDIT_MODAL_DATA:", a), t.editModalData = M({}, a), t.showPasswordOnModal = !1;
                else {
                    var n = i("25b7"),
                        o = n.generate({
                            length: 16,
                    ...
                    c.ratelimit_limit = t.defaultRLLimit, c.ratelimit_period = t.defaultRLPeriod, c.ratelimit_custom = !1, t.editModalData = M({}, c), t.showPasswordOnModal = !0
                }
            ...
            })), Object(u["a"])(m, P.mutations.EDIT_MODAL_OPEN_TRACKING, (function(t, e) {
                t.editModalData.open_tracking = e
            })), Object(u["a"])(m, P.mutations.EDIT_MODAL_CLICK_TRACKING, (function(t, e) {
            ...
            })), Object(u["a"])(m, P.mutations.EDIT_MODAL_ARCHIVING_INITIAL, (function(t, e) {
            ...
            })), Object(u["a"])(m, P.mutations.EDIT_MODAL_BOUNCE_NOTIFICATIONS, (function(t, e) {
                t.editModalData.bounce_notifications = e
            })), Object(u["a"])(m, P.mutations.EDIT_MODAL_BOUNCE_TARGET, (function(t, e) {
                t.editModalData.bounce_target = e
            })), Object(u["a"])(m, P.mutations.EDIT_MODAL_ENDPOINTS, (function(t, e) {
                t.editModalData.endpoints = e
            })), Object(u["a"])(m, P.mutations.ADD_EDIT_MODAL_ENDPOINTS, (function(t, e) {
                t.editModalData.endpoints.push(e)
            })), Object(u["a"])(m, P.mutations.DELETE_EDIT_MODAL_ENDPOINTS, (function(t, e) {
                t.editModalData.endpoints = t.editModalData.endpoints.filter((function(t) {
                    return t !== e
                }))
            })), Object(u["a"])(m, P.mutations.SET_IS_ALLOWED_ARCHIVING, (function(t, e) {
            ...
            x = (f = {}, Object(u["a"])(f, P.actions.SAVE_COLUMNS, (function(t) {
                if (t.state.columns_need_saving) return new Promise((function(e, i) {
                    S.put(t.rootGetters[E.getters.BACKEND_URL]("API Keys", "save-columns"), {
                ...
                var i = e.isSearch;
                void 0 !== i && i && t.commit(P.mutations.SET_NO_USER_MESSAGE, "No API Keys users matched the search criteria"), N.searchTextChanged && t.commit(P.mutations.SET_CURRENT_PAGE, 0);
                var s = !1;
                return 0 === N.current_page ? t.commit(P.mutations.SET_IS_FETCHING_ACTIVE_USERS, !0) : (s = !0, t.commit(P.mutations.SET_IS_FETCHING_MORE_ACTIVE_USERS, !0)), new Promise((function(e, i) {
                    var a = new URLSearchParams(window.location.search),
                        n = a.has("show_hidden_endpoints");
                    S.post(t.rootGetters[E.getters.BACKEND_URL]("API Keys", "load-active-users"), {
                        page_offset: N.current_page,
                        search_text: N.searchText,
                        show_hidden_endpoints: n
                    }).then((function(i) {
                        t.commit(P.mutations.SET_SEARCH_TEXT_CHANGED, !1), s ? t.commit(P.mutations.ADD_ACTIVE_USERS, i.results.users) : t.commit(P.mutations.SET_ACTIVE_USERS, i.results.users), t.commit(P.mutations.SET_GENERATED_KEY_DATA, i.results.generated_key), t.commit(P.mutations.CAN_LOAD_MORE, i.results.total_users > N.active_users.length), t.commit(P.mutations.SET_CURRENT_PAGE, N.current_page + 1), t.commit(P.mutations.SET_API_INDEX, i.results.api_index.groups), e(i)
                    })).catch((function(t) {
                        i(t)
                    }))
                })).then((function() {
                    s ? t.commit(P.mutations.SET_IS_FETCHING_MORE_ACTIVE_USERS, !1) : t.commit(P.mutations.SET_IS_FETCHING_ACTIVE_USERS, !1)
                }))
            })), Object(u["a"])(f, P.actions.REMOVE_ACTIVE_USER, (function(t, e) {
                var i = e.username;
                return new Promise((function(e, s) {
                    S.post(t.rootGetters[E.getters.BACKEND_URL]("API Keys", "remove-active-user"), {
                        username: i
                    }).then((function(s) {
                        t.commit(P.mutations.REMOVE_ACTIVE_USER, {
                            username: i
                        }), e(s)
                    })).catch((function(t) {
                        s(t)
                ...
                return new Promise((function(e, D) {
                    ...
                    N.ip_pools.forEach((function(t) {
                    ...
                    })), S.post(t.rootGetters[E.getters.BACKEND_URL]("API Keys", "update-active-user"), {
                        full_api_key: i,
                        description: s,
                        ippool: a,
                        ratelimit_limit: n,
                        ...
                        }), t.commit(P.mutations.SET_GENERATED_KEY_DATA, s.results.generated_key), e(s)
                    })).catch((function(t) {
                        D(t)
                    }))
                }))
                ...
                return new Promise((function(e, a) {
                    S.post(t.rootGetters[E.getters.BACKEND_URL]("API Keys", "update-default-ratelimit"), {
                        ratelimit_limit: i,
                        ratelimit_period: s
                    }).then((function(i) {
                        t.commit(P.mutations.SET_DEFAULT_RL_LIMIT, i.results.ratelimit_limit), t.commit(P.mutations.SET_DEFAULT_RL_PERIOD, i.results.ratelimit_period), e(i)
                    })).catch((function(t) {
                        a(t)
                    }))
                }))
                ...
                return new Promise((function(e, i) {
                    var s = I.a.create();
                    s.get("https://api.smtp2go.com/v3/api/echo").then((function() {
            ...
            G = function() {
                ...
                return e("div", {
                    ...
                    scopedSlots: t._u([{
                        key: "description",
                        fn: function() {
                            return [e("p", [t._v("Create and manage API keys required to use the SMTP2GO API.")])]
                        },
                        proxy: !0
                    }])
                }, [e("div", {
            ...
            J = Q,
            z = (i("aa61"), i("d96c"), Object(W["a"])(J, B, F, !1, null, "5562029a", null)),
            Z = z.exports,
            tt = function() {
                var t = this,
                    e = t._self._c;
            ...
            ot = (i("6762"), i("2fdb"), function() {
                ...
                return e("table", {
                    ...
                    return e("tr", {
                        ...
                        }, [t._v("Allowed")])] : "ratelimit" === s.id ? [e("span", {
                            staticClass: "label ratelimit"
                        }, [t._v(t._s(t.prettyPrintRL(i)))])] : ["archiving", "open_tracking", "click_tracking"].includes(s.id) ? [i[s.id] ? e("span", {
                            staticClass: "label secondary"
                        }, [t._v("Enabled")]) : e("span", {
                            staticClass: "label disabled"
                        }, [t._v("Disabled")])] : e("span", [t._v(t._s(i[s.id]))]) : [e("a", {
                            attrs: {
                                href: "#"
                            },
                            on: {
                        ...
                        }, [t._v(t._s(t.obfuscateUsername(i[s.id])))]), e("a", {
                            staticClass: "btn button-download copy-button",
                            attrs: {
                                "key-src": i.password
                            },
                            on: {
                                click: function(e) {
                                    return e.preventDefault(), t.copyFullAPIKeyToClipboard.apply(null, arguments)
                                }
                            }
                        }, [t._v("Copy")])]], 2)
                    })), e("td", {
            ...
            ct = (i("3b2b"), i("14b9"), i("c5f6"), i("7514"), i("7f7f"), i("0d6d"), Object.freeze({
        ...
        var bt = pt,
            vt = (i("28a5"), i("4917"), {
                methods: {
                    mixinHelpers_prettyPrintRatelimit: Ot
                }
            });
        ...
        var Tt = vt,
            ...
            Mt = function() {
                ...
                }, [t._v("\n      Load More Results\n    ")]) : t._e(), t.isFetchingMoreActiveUsers ? e("div", {
        ...
        function Nt(t) {
            for (var e = 1; e < arguments.length; e++) {
                var i = null != arguments[e] ? arguments[e] : {};
                e % 2 ? yt(Object(i), !0).forEach((function(e) {
                    Object(u["a"])(t, e, i[e])
        ...
        var Rt = {
            ...
            kt = Rt,
            wt = (i("d2bb"), i("8aa3"), Object(W["a"])(kt, Mt, Pt, !1, null, "26ee5526", null)),
            Ut = wt.exports;
        ...
        var Gt = {
                ...
                computed: jt(jt({}, Object(_["b"])({
                    ...
                    isAutomatic: {
                        ...
                        set: function(t) {
                            this.$store.commit(y.mutations.SET_IS_AUTOMATIC_COLS, t), this.activeColumnCountToClass()
                        }
                    },
                    ...
                    sortedTableResults: function() {
                        ...
                        return e ? Object(A["a"])(this.tableResults).sort((function(e, i) {
                            ...
                            var c = t.normalizeSortValue(t.getSortValue(e, t.sortBy)),
                                l = t.normalizeSortValue(t.getSortValue(i, t.sortBy)),
                                u = c.localeCompare(l);
                ...
                created: function() {
                    this.mixinEventListener_register(Object(u["a"])({}, ct.TRIGGERABLE_CLOSED, this.onTriggerableClosed)), this.mixinEventListener_on()
                },
                destroyed: function() {
                ...
                methods: {
                    ...
                    copyFullAPIKeyToClipboard: function(t) {
                        ...
                        try {
                            navigator.clipboard.writeText(i), e.text("Copied!"), e.addClass("success")
                        } catch (t) {
                            console.log(t), e.text("Failed to Copy!"), e.addClass("error")
                        }
                        window.setTimeout((function() {
                            e.text("Copy"), e.removeClass("error"), e.removeClass("success")
                        }), 2e3)
                    },
                    prettyPrintIPPool: function(t) {
                        var e = t.ippool;
                        return t.use_default_ippool ? "Default" : this.$store.getters[y.getters.GET_IP_POOL_LABEL](e)
                    },
                    ...
                    handleColumnToggle: function(t, e) {
                        console.log("handle column toggle"), void 0 !== t && t.stopImmediatePropagation(), this.$store.commit(y.mutations.TOGGLE_IS_COLUMN_SHOWN, e.id), this.activeColumnCountToClass()
                    },
                    ...
                    deletePopupClick: function(t) {
                        ...
                        this.hideAllDeletePopup(), this.$store.commit(y.mutations.SET_ACTIVE_USER_PROPERTY, {
                            active_user: t,
                            key: "displayDeletePopup",
                            value: !e
                        })
                    ...
                    performDeleteClick: function(t) {
                        var e = this;
                        this.mixinAlerts_clear(), this.$set(this.deleteRequests, t.username, !0), this.$store.dispatch(y.actions.REMOVE_ACTIVE_USER, {
                            username: t.username
                        }).then((function() {
                            e.deleteRequests[t.username] = void 0, e.$store.commit(y.mutations.SET_ACTIVE_USER_PROPERTY, {
                                active_user: t,
                                key: "displayDeletePopup",
                                value: !1
                    ...
                    edit: function(t) {
                        this.$store.commit(y.mutations.TOGGLE_EDIT_MODAL, {
                            ...
                            i.style.height = "".concat(s, "px"), i.classList.add("is-edit")
                        }), 300)
                    },
            ...
            Ht = Gt,
            Bt = (i("3e49"), Object(W["a"])(Ht, ot, rt, !1, null, "0a9f98db", null)),
            $t = Bt.exports,
            Ft = function() {
                var t = this,
                    e = t._self._c;
                return e("div", {
                ...
                }, [t._v(t._s(this.is_editing ? "Edit API" : "Add API") + " Key")])]), e("div", {
                    staticClass: "lead-toggle"
                }, [e("p", [t._v(t._s(this.is_editing ? "Edit" : "Add") + "  your API Key details below. Optionally set an email sending rate limit, unsubscribe footer, or choose advanced options for additional features.")])])]), e("div", {
                    ...
                    on: {
                        click: function(e) {
                            e.preventDefault(), t.activeTab = "permissions"
                        }
                    }
                }, [e("span", [t._v("Permissions")])]), e("a", {
                    staticClass: "tab",
                    class: {
                    ...
                    attrs: {
                        ...
                        disabled: !t.ratelimit_custom || "unlimited" == t.ratelimit_period
                    },
                    domProps: {
                        value: t.ratelimit_limit
                    },
                ...
                }, [t._v("Specify the number of emails that can be sent per time period.")])])])]), e("div", {
                    ref: "permissions",
                    ...
                    staticClass: "column-permissions left-column"
                }, t._l(t.leftColumnEndpoints, (function(i, s) {
                    return e("li", {
                        key: s,
                        class: ["permission-panel", t.isGroupSelected(s), {
                            "child-active": t.isPanelOpen(s)
                        }],
                        attrs: {
                            title: s
                        }
                    }, [e("input", {
                        staticClass: "pp-select-all permission-parent-input is-select-all",
                        attrs: {
                            type: "checkbox"
                        },
                        on: {
                        ...
                        staticClass: "permission-panel-title",
                        on: {
                            click: function(e) {
                        ...
                        on: {
                            click: function(e) {
                                return e.preventDefault(), t.togglePanel(s)
                            }
                        }
                    }), e("ul", {
                        staticClass: "panel-dropdown",
                        class: {
                            "is-active": t.isPanelOpen(s)
                        }
                    }, t._l(i.endpoints, (function(i) {
                        return e("li", {
                            key: i.path,
                            staticClass: "permission-row panel-dropdown-item"
                        }, [e("label", {
                            class: {
                                "is-selected": t.isEndpointSelected(i.permission_id)
                            },
                            on: {
                                click: function(e) {
                                    return e.preventDefault(), t.togglePermissionItem(i.permission_id)
                                }
                            }
                        }, [e("input", {
                            staticClass: "permission-panel-input",
                            attrs: {
                                type: "checkbox",
                                name: "endpoint[]"
                            }
                    ...
                    staticClass: "column-permissions right-column"
                }, t._l(t.rightColumnEndpoints, (function(i, s) {
                    return e("li", {
                        key: s,
                        class: ["permission-panel", t.isGroupSelected(s), {
                            "child-active": t.isPanelOpen(s)
                    ...
                    staticClass: "field-info"
                }, [t._v("Enable open tracking to find out when a recipient has opened an\n                      email.")])])]), e("div", {
                    staticClass: "form-group"
                }, [e("label", {
                    staticClass: "form-group-label"
                    ...
                    staticClass: "field-info"
                }, [t._v("Enable click tracking to find out when a recipient has clicked a link in\n                      an email.")])])]), e("div", {
                    staticClass: "form-group"
                }, [e("label", {
                    staticClass: "form-group-label"
                    ...
                    domProps: {
                        innerHTML: t._s(t.getSelectedItem.description)
                    }
                })])])])])]), e("div", {
                    ref: "archiving",
                ...
                }, [t._v(t._s(this.is_editing ? "Save Changes" : "Add API Key"))]), e("base-button", {
                    attrs: {
                ...
                }, [e("h5", [t._v("Connection information")]), t._m(9), e("p", [e("strong", [t._v("API Status: ")]), e("span", {
                    style: t.apiStatusStyle,
                    attrs: {
                        id: "api_status"
                    }
                }, [t._v(t._s(t.apiStatus))])]), t._m(10)])]), e("div", {
                    ...
                    class: {
                        "is-active": t.showPermissionsModal
                    }
                }, [e("div", {
                    staticClass: "modal-body"
                }, [e("button", {
                    ...
                    on: {
                        click: function(e) {
                            t.showPermissionsModal = !1, t.apiNotificationSeen = !1
                        }
                    }
                }, [t._v("Ã—")]), t._m(12), e("div", {
                    staticClass: "modal-body-footer"
                }, [e("div", [e("button", {
                    staticClass: "btn blue",
                    on: {
                ...
                }, [t._v("Add API Key")]), e("button", {
                    staticClass: "btn button-outlined bootbox-close-button",
                    on: {
                        click: function(e) {
                            t.showPermissionsModal = !1, t.activeTab = "permissions", t.hasSeenPermissionsModal = !0, t.apiNotificationSeen = !1
                        }
                    }
                }, [t._v("Cancel")])]), e("div", [e("label", {
                    class: ["permission-modal-label", {
                        "is-selected": t.apiNotificationSeen
                    }],
                    on: {
                        click: function(e) {
                            return e.preventDefault(), t.toggleModalStopNotifying.apply(null, arguments)
                        }
                    }
                }, [e("input", {
            ...
            Vt = [function() {
                ...
                var t = this,
                    e = t._self._c;
                return e("p", [e("strong", [t._v("API Base URL: ")]), t._v(" https://api.smtp2go.com/v3/")])
            }, function() {
                var t = this,
                    e = t._self._c;
                return e("p", [e("strong", [t._v("API Docs: ")]), e("a", {
                    attrs: {
                        target: "_blank",
                ...
                return e("div", {
                    staticClass: "option-banner"
                }, [e("h4", [t._v("Review Permissions")]), e("p", [t._v("Your API key has only one permission enabled: "), e("strong", [t._v("/email/send")])]), e("p", [t._v("If you meant to include more permissions, you can add them on the Permissions tab on this page. Otherwise, click â€˜Add API Keyâ€™ below.")])])
            }],
            Kt = (i("ac4d"), i("8a81"), i("5df3"), i("1c4c"), i("6b54"), function() {
                var t = this,
                    e = t._self._c;
                return e("button", {
                    staticClass: "btn",
        ...
        function Jt(t, e) {
            ...
            if (!i) {
                if (Array.isArray(t) || (i = zt(t)) || e && t && "number" === typeof t.length) {
                    i && (t = i);
                    var s = 0,
                        a = function() {};
                    return {
        ...
        var ie = {
                ...
                data: function() {
                    return {
                        ...
                        dropdownItems: [{
                            ...
                            name: "Blocked",
                            description: 'Sending is <span class="emphasis red">denied</span>, along with all other API access.',
                            colorClass: "red"
                        }, {
                            name: "Sandboxed",
                ...
                computed: ee(ee({}, Object(_["b"])({
                    ...
                    apiStatusStyle: function() {
                        return null === this.isApiOnline ? "" : this.isApiOnline ? "background: #e2f8e8; color: #006042; display: inline-block; padding: 0 3px; border-radius: 3px !important; width: auto; min-height: auto;" : "background: #fdefed; color: #ce715f; display: inline-block; padding: 0 3px; border-radius: 3px !important; width: auto; min-height: auto;"
                    },
                    apiStatus: function() {
                        return null === this.isApiOnline ? "Querying API..." : this.isApiOnline ? "Online" : "Offline"
                    },
                    inputType: function() {
                    ...
                    showPassword: {
                        get: function() {
                            return this.$store.getters[y.getters.GET_SHOW_PASSWORD_ON_MODAL]
                        }
                    },
                    is_editing: {
                        get: function() {
                    ...
                    username: {
                        get: function() {
                            ...
                            return this.is_editing || (t = this.$store.getters[y.getters.GET_GENERATED_KEY_DATA].key), t.substr(0, 9) + "x".repeat(23)
                        },
                        set: function(t) {
                    ...
                    password: {
                        get: function() {
                            return this.is_editing ? this.$store.getters[y.getters.EDIT_MODAL_PASSWORD] : this.$store.getters[y.getters.GET_GENERATED_KEY_DATA].key
                        },
                        set: function(t) {
                            this.$store.commit(y.mutations.EDIT_MODAL_PASSWORD, t)
                        }
                    ...
                    archiving_initial: {
                        get: function() {
                            return this.$store.getters[y.getters.EDIT_MODAL_ARCHIVING_INITIAL]
                        },
                        set: function(t) {
                    ...
                    bounce_notifications: {
                        get: function() {
                            return this.$store.getters[y.getters.EDIT_MODAL_BOUNCE_NOTIFICATIONS]
                        },
                        set: function(t) {
                            var e = this;
                            this.$store.commit(y.mutations.EDIT_MODAL_BOUNCE_NOTIFICATIONS, t), this.$nextTick((function() {
                                var i = 55;
                    ...
                    bounce_target: {
                        ...
                        set: function(t) {
                            this.$store.commit(y.mutations.EDIT_MODAL_BOUNCE_TARGET, t), this.bnOriginal = !t, this.bnEmail = t
                        }
                    },
                    ...
                    selectedDropdownItemName: function() {
                        return this.sandbox_mode ? "Sandboxed" : this.blocked ? "Blocked" : "Allowed"
                    },
                    ...
                    leftColumnEndpoints: function() {
                        for (var t = {}, e = 0, i = 0, s = Object.entries(this.apiIndex); i < s.length; i++) {
                ...
                methods: ee(ee({}, Object(_["c"])({
                    ...
                    close: function() {
                        var t = this;
                        this.hasSeenPermissionsModal = !1, this.hasToggledPermissions = !1, this.isClosing = !0, this.error_msg_visible = !1, this.$store.commit(y.mutations.TOGGLE_EDIT_MODAL, {
                            visible: !1,
                            data: null
                        }), this.$nextTick((function() {
                            t.activeTab = "details"
                        ...
                        i.style.height = "".concat(a, "px"), i.classList.remove("is-edit");
                            ...
                            var i = new MutationObserver((function(e) {
                                    ...
                                    try {
                                        for (s.s(); !(i = s.n()).done;) {
                                            ...
                                            n && "attributes" === a.type && "class" === a.attributeName && (a.target.classList.contains("is-open") || a.target.classList.contains("is-closed")) && setTimeout((function() {
                    ...
                    buildSavePayload: function() {
                        ...
                        return this.apiNotificationSeen && (e.api_notification_seen = this.apiNotificationSeen), this.is_editing ? e._hash = this.edit_hash : (e.full_api_key = this.$store.getters[y.getters.GET_GENERATED_KEY_DATA].key, e._hash = this.$store.getters[y.getters.GET_GENERATED_KEY_DATA].hash), e
                    },
                    save: function(t) {
                        var e = this;
                        if (this.isSaving = !0, this.error_msg_visible = !1, !this.is_editing) {
                            if (!(this.hasSeenPermissionsModal || this.hasToggledPermissions || t || this.savedApiNotificationSeen)) return this.isSaving = !1, void(this.showPermissionsModal = !0);
                            this.showPermissionsModal = !1
                        }
                        this.apiNotificationSeen && this.saveApiNotificationSeen(!0), this.$store.dispatch(y.actions.UPDATE_ACTIVE_USER, this.buildSavePayload()).then((function() {
                            e.isSaving = !1, e.is_editing ? e.mixinAlerts_success("Successfully updated API Key") : (e.mixinAlerts_success("Successfully added API Key"), e.hasSeenPermissionsModal = !1, e.hasToggledPermissions = !1), e.close()
                        })).catch((function(t) {
                            e.isSaving = !1, e.error_msg = t, e.error_msg_visible = !0, e.$nextTick((function() {
                                e.adjustPageHeigthEdit()
                            }))
                        }))
                    },
                    togglePassword: function() {
                        this.$store.commit(y.mutations.SET_SHOW_PASSWORD_ON_MODAL, !this.showPassword)
                    },
                    ...
                    toggleSelectAll: function(t) {
                        if (this.hasToggledPermissions = !0, "child-selected" != this.isGroupSelected(t)) {
                            var e, i = Jt(this.apiIndex[t].endpoints);
                            try {
                                for (i.s(); !(e = i.n()).done;) {
                                    var s = e.value;
                                    this.endpoints.includes(s.permission_id) || this.addEndpoints(s.permission_id)
                                }
                            } catch (r) {
                                i.e(r)
                            } finally {
                            ...
                            var a, n = Jt(this.apiIndex[t].endpoints);
                            try {
                                for (n.s(); !(a = n.n()).done;) {
                                    var o = a.value;
                    ...
                    togglePanel: function(t) {
                        var e = this,
                            i = document.querySelector('.permission-panel[title="'.concat(t, '"] .panel-dropdown'));
                        if (this.openPanels.includes(t)) this.openPanels = this.openPanels.filter((function(e) {
                            return e !== t
                        })), this.$nextTick((function() {
                            var t = e.$refs[e.activeTab].clientHeight - i.scrollHeight + 2;
                            e.$refs.tabWrapper.style.height = "".concat(t, "px"), i.style.maxHeight = null
                        }));
                        else {
                            i.style.visibility = "hidden", i.style.maxHeight = "none", i.classList.add("is-active");
                            var s = i.scrollHeight + 6;
                            i.style.visibility = "", i.style.maxHeight = "", this.openPanels.push(t), this.$nextTick((function() {
                                i.style.maxHeight = "".concat(s, "px"), e.$refs.tabWrapper.style.height = "".concat(e.$refs[e.activeTab].clientHeight + 2, "px")
                            }))
                        }
                        setTimeout((function() {
                            e.adjustPageHeigthEdit()
                    ...
                    togglePermissionItem: function(t) {
                        this.hasToggledPermissions = !0, this.endpoints.includes(t) ? this.deleteEndpoints(t) : this.addEndpoints(t)
                    },
                    ...
                    isGroupSelected: function(t) {
                        var e = !0,
                            i = !0,
                            s = this.endpoints;
                        return this.apiIndex[t]["endpoints"].forEach((function(t) {
                            s.includes(t.permission_id) ? i = !1 : e = !1
                        })), e ? "child-selected" : i ? "child-deselected" : "child-indeterminate"
                    },
                ...
                mounted: function() {
                    ...
                    })), document.addEventListener("click", this.handleOutsideClick), this.setupCheckboxMutationObserver()
                },
                beforeDestroy: function() {
                    document.removeEventListener("click", this.handleOutsideClick), this.checkboxObserver && this.checkboxObserver.disconnect()
                },
                watch: {
                    isActive: function(t) {
                        var e = this;
                    ...
                    activeTab: function() {
                        var t = this;
                        this.dropdownIsActive = !1, this.isClosing || this.$nextTick((function() {
                            t.updateHeight(), setTimeout((function() {
                                t.adjustPageHeigthEdit()
                            }), 300)
                        }))
                    }
            ...
            oe = function() {
                ...
                return e("div", {
                ...
                }, [e("h5", [t._v("Connection information")]), t._m(0), e("p", [e("strong", [t._v("API Status: ")]), e("span", {
                    style: t.apiStatusStyle,
                    attrs: {
                        id: "api_status"
                    }
                }, [t._v(t._s(t.apiStatus))])]), t._m(1)]), e("div", {
                    staticClass: "card--fyi--large"
                }, [e("h5", [t._v("Default Rate Limit Per API Key")]), e("p", [t._v("\n      If an API key has no rate limit set, they'll use this default limit.\n    ")]), e("p", {
                    staticClass: "current_limit--outer"
                }, [t._v("\n      It's currently set to\n      "), e("strong", [e("span", {
                    staticClass: "current_limit"
                }, [t._v(t._s(t.prettyPrintRL))])]), t._v(".\n    ")]), e("div", {
                    ...
                    staticClass: "form-control",
                    attrs: {
                        name: "per_apiauth_relay_limit_period"
                    },
                    on: {
                        change: function(e) {
                            var i = Array.prototype.filter.call(e.target.options, (function(t) {
        ...
        function le(t) {
            for (var e = 1; e < arguments.length; e++) {
                var i = null != arguments[e] ? arguments[e] : {};
                e % 2 ? ce(Object(i), !0).forEach((function(e) {
                    Object(u["a"])(t, e, i[e])
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : ce(Object(i)).forEach((function(e) {
                    Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                }))
            }
            return t
        ...
        var ue = {
                ...
                mounted: function() {
                    this.ratelimit_limit = this.$store.state.apiauth.defaultRLLimit, this.ratelimit_period = this.$store.state.apiauth.defaultRLPeriod
                },
                computed: le(le({}, Object(_["b"])({
                    isApiOnline: y.getters.GET_IS_API_ONLINE
                })), {}, {
                    apiStatusStyle: function() {
                        return null === this.isApiOnline ? "" : this.isApiOnline ? "background: #e2f8e8; color: #006042; display: inline-block; padding: 0 3px; border-radius: 3px !important; width: auto; min-height: auto;" : "background: #fdefed; color: #ce715f; display: inline-block; padding: 0 3px; border-radius: 3px !important; width: auto; min-height: auto;"
                    ...
                    prettyPrintRL: function() {
                        return this.mixinHelpers_prettyPrintRatelimit(this.$store.state.apiauth.defaultRLLimit, this.$store.state.apiauth.defaultRLPeriod)
                    },
                ...
                methods: {
                    ...
                    save: function() {
                        ...
                        if (this.mixinAlerts_clear(), "" !== this.ratelimit_limit || "unlimited" === this.ratelimit_period) {
                            ...
                            (isNaN(e) || e <= 0) && "unlimited" !== this.ratelimit_period ? this.mixinAlerts_error("Limit must be a number") : (this.isSaving = !0, this.$store.dispatch(y.actions.UPDATE_DEFAULT_RATELIMIT, {
                                ratelimit_limit: this.ratelimit_limit,
                                ratelimit_period: this.ratelimit_period
                            }).then((function() {
        ...
        var he = {
                ...
                methods: {
                    ...
                    search: function() {
                        this.$store.commit(y.mutations.SET_CURRENT_PAGE, 0), this.$store.dispatch(y.actions.LOAD_ACTIVE_USERS, {
                            isSearch: !0
                        })
                    }
                }
            ...
            Ee = he,
            ge = (i("5176"), i("cbb0"), Object(W["a"])(Ee, G, H, !1, null, "4c2d82f3", null)),
            be = ge.exports;
        ...
        var Te = {
                ...
                mounted: function() {
                    ...
                    })), this.$store.dispatch(y.actions.QUERY_API_STATUS), this.$eventBus.$on("showPopup", this.showPopup), this.$eventBus.$on("showPopupImmediately", this.showPopupImmediately)
                },
                methods: {
                    hideSplash: function() {
            ...
            Ae = Te,
            De = (i("31bd"), i("b356"), Object(W["a"])(Ae, c, l, !1, null, "17abb530", null)),
            Ie = De.exports;
        n["a"].use(_["a"]);
        var Se = new _["a"].Store({
            ...
            Ce = Se;
        n["a"].use(r.a), n["a"].config.productionTip = !1, n["a"].prototype.$eventBus = new n["a"], Ce.commit(E.mutations.SET_CSRF_KEY, PAGE_DATA.csrfkey), Ce.commit(E.mutations.SET_SHOW_SPLASH, PAGE_DATA.showSplash), Ce.commit(E.mutations.SET_END_POINTS, END_POINTS.urls()), Ce.commit(y.mutations.SET_APP_SETTINGS, PAGE_DATA.appSettings), Ce.commit(y.mutations.SET_IP_POOLS, PAGE_DATA.ip_pools), Ce.commit(y.mutations.SET_API_NOTIFICATION_SEEN, PAGE_DATA.api_notification_seen), Ce.commit(y.mutations.SET_DEFAULT_RL_LIMIT, PAGE_DATA.ratelimits.default_limit), Ce.commit(y.mutations.SET_DEFAULT_RL_PERIOD, PAGE_DATA.ratelimits.default_period), Ce.commit(y.mutations.SET_IS_ALLOWED_ARCHIVING, PAGE_DATA.isAllowedArchiving), C(Ce), new n["a"]({
            store: Ce,
            render: function(t) {
                return t(Ie)
            }
...
//# sourceMappingURL=app.fdb3d8a9.js.map