! function(t, e) {
    ...
    var a = function(a, i, s) {
        ...
        if (this.isFormatContainsTime = d.every(function(t) {
                return t.original.hours() === t.parsed.hours() && t.original.minutes() === t.parsed.minutes()
            }), "string" == typeof i.startDate && (this.startDate = t(i.startDate, this.locale.format)), "string" == typeof i.endDate && (this.endDate = t(i.endDate, this.locale.format)), "string" == typeof i.minDate && (this.minDate = t(i.minDate, this.locale.format)), "string" == typeof i.maxDate && (this.maxDate = t(i.maxDate, this.locale.format)), "object" == typeof i.startDate && (this.startDate = t(i.startDate)), "object" == typeof i.endDate && (this.endDate = t(i.endDate)), "object" == typeof i.minDate && (this.minDate = t(i.minDate)), "object" == typeof i.maxDate && (this.maxDate = t(i.maxDate)), this.minDate && this.startDate.isBefore(this.minDate) && (this.startDate = this.minDate.clone()), this.maxDate && this.endDate.isAfter(this.maxDate) && (this.endDate = this.maxDate.clone()), "string" == typeof i.applyButtonClasses && (this.applyButtonClasses = i.applyButtonClasses), "string" == typeof i.applyClass && (this.applyButtonClasses = i.applyClass), "string" == typeof i.cancelButtonClasses && (this.cancelButtonClasses = i.cancelButtonClasses), "string" == typeof i.cancelClass && (this.cancelButtonClasses = i.cancelClass), "object" == typeof i.maxSpan && (this.maxSpan = i.maxSpan), "object" == typeof i.dateLimit && (this.maxSpan = i.dateLimit), "string" == typeof i.opens && (this.opens = i.opens), "string" == typeof i.drops && (this.drops = i.drops), "boolean" == typeof i.showWeekNumbers && (this.showWeekNumbers = i.showWeekNumbers), "boolean" == typeof i.showISOWeekNumbers && (this.showISOWeekNumbers = i.showISOWeekNumbers), "string" == typeof i.buttonClasses && (this.buttonClasses = i.buttonClasses), "object" == typeof i.buttonClasses && (this.buttonClasses = i.buttonClasses.join(" ")), "boolean" == typeof i.showDropdowns && (this.showDropdowns = i.showDropdowns), "number" == typeof i.minYear && (this.minYear = i.minYear), "number" == typeof i.maxYear && (this.maxYear = i.maxYear), "boolean" == typeof i.showCustomRangeLabel && (this.showCustomRangeLabel = i.showCustomRangeLabel), "boolean" == typeof i.singleDatePicker && (this.singleDatePicker = i.singleDatePicker, this.singleDatePicker && (this.endDate = this.startDate.clone())), "boolean" == typeof i.timePicker && (this.timePicker = i.timePicker), "boolean" == typeof i.timePickerSeconds && (this.timePickerSeconds = i.timePickerSeconds), "number" == typeof i.timePickerIncrement && (this.timePickerIncrement = i.timePickerIncrement), "boolean" == typeof i.timePicker24Hour && (this.timePicker24Hour = i.timePicker24Hour), "boolean" == typeof i.timePickerPadHours && (this.timePickerPadHours = i.timePickerPadHours), "boolean" == typeof i.autoApply && (this.autoApply = i.autoApply), "boolean" == typeof i.autoUpdateInput && (this.autoUpdateInput = i.autoUpdateInput), "boolean" == typeof i.linkedCalendars && (this.linkedCalendars = i.linkedCalendars), "function" == typeof i.isInvalidDate && (this.isInvalidDate = i.isInvalidDate), "function" == typeof i.isCustomDate && (this.isCustomDate = i.isCustomDate), "boolean" == typeof i.alwaysShowCalendars && (this.alwaysShowCalendars = i.alwaysShowCalendars), 0 != this.locale.firstDay)
            for (var m = this.locale.firstDay; m > 0;) this.locale.daysOfWeek.push(this.locale.daysOfWeek.shift()), m--;
        if (void 0 === i.startDate && void 0 === i.endDate && e(this.element).is(":text")) {
            var p = e(this.element).val(),
                f = p.split(this.locale.separator);
            o = h = null, 2 == f.length ? (o = t(f[0], this.locale.format), h = t(f[1], this.locale.format)) : this.singleDatePicker && "" !== p && (o = t(p, this.locale.format), h = t(p, this.locale.format)), null !== o && null !== h && (this.setStartDate(o), this.setEndDate(h))
        }
        if ("object" == typeof i.ranges) {
            for (l in i.ranges) {
                ...
                var u = this.maxDate;
                if (this.maxSpan && u && o.clone().add(this.maxSpan).isAfter(u) && (u = o.clone().add(this.maxSpan)), u && h.isAfter(u) && (h = u.clone()), !(this.minDate && h.isBefore(this.minDate, this.timepicker ? "minute" : "day") || u && o.isAfter(u, this.timepicker ? "minute" : "day"))) {
                    var D;
            ...
            var g = "<ul>";
            for (l in this.ranges) g += '<li data-range-key="' + l + '">' + l + "</li>";
            this.showCustomRangeLabel && (g += '<li data-range-key="' + this.locale.customRangeLabel + '">' + this.locale.customRangeLabel + "</li>"), g += "</ul>", this.container.find(".ranges").prepend(g)
        }
    ...
    return a.prototype = {
        ...
        renderCalendar: function(a) {
            ...
            for (var y = t([p, m, g, 12, o, h]), k = (D = 0, 0), v = 0; D < 42; D++, k++, y = t(y).add(24, "hour")) D > 0 && k % 7 == 0 && (k = 0, v++), i[v][k] = y.clone().hour(r).minute(o).second(h), y.hour(12), this.minDate && i[v][k].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && i[v][k].isBefore(this.minDate) && "left" == a && (i[v][k] = this.minDate.clone()), this.maxDate && i[v][k].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && i[v][k].isAfter(this.maxDate) && "right" == a && (i[v][k] = this.maxDate.clone());
            ...
            if (this.showDropdowns) {
                for (var P = i[1][1].month(), x = i[1][1].year(), M = C && C.year() || this.maxYear, I = b && b.year() || this.minYear, S = x == I, B = x == M, A = '<select class="monthselect">', L = 0; L < 12; L++)(!S || b && L >= b.month()) && (!B || C && L <= C.month()) && (A += "<option value='" + L + "'" + (L === P ? " selected='selected'" : "") + ">" + this.locale.monthNames[L] + "</option>");
                A += "</select>";
            ...
            for (v = 0; v < 6; v++) {
                ...
                for (k = 0; k < 7; k++) {
                    var O = [];
                    i[v][k].isSame(new Date, "day") && O.push("today"), i[v][k].isoWeekday() > 5 && O.push("weekend"), i[v][k].month() != i[1][1].month() && O.push("off", "ends"), this.minDate && i[v][k].isBefore(this.minDate, "day") && O.push("off", "disabled"), C && i[v][k].isAfter(C, "day") && O.push("off", "disabled"), this.isInvalidDate(i[v][k]) && O.push("off", "disabled"), i[v][k].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && O.push("active", "start-date"), null != this.endDate && i[v][k].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && O.push("active", "end-date"), null != this.endDate && i[v][k] > this.startDate && i[v][k] < this.endDate && O.push("in-range");
                    ...
                    R || (j += "available"), Y += '<td class="' + j.replace(/^\s+|\s+$/g, "") + '" data-title="r' + v + "c" + k + '">' + i[v][k].date() + "</td>"
                }
                Y += "</tr>"
            }
        ...
        renderTimePicker: function(t) {
            if ("right" != t || this.endDate) {
                ...
                for (var o = this.timePicker24Hour ? 0 : 1, h = this.timePicker24Hour ? 23 : 12, l = o; l <= h; l++) {
                    var c, d = l;
                    this.timePicker24Hour || (d = a.hour() >= 12 ? 12 == l ? 12 : l + 12 : 12 == l ? 0 : l), c = this.timePickerPadHours && l < 10 ? "0" + l : l;
                    var m = a.clone().hour(d),
                        p = !1;
                    i && m.minute(59).isBefore(i) && (p = !0), s && m.minute(0).isAfter(s) && (p = !0), d != a.hour() || p ? e += p ? '<option value="' + l + '" disabled="disabled" class="disabled">' + c + "</option>" : '<option value="' + l + '">' + c + "</option>" : e += '<option value="' + l + '" selected="selected">' + c + "</option>"
                }
                e += "</select>", e += '<span class="time-divider">:</span><select class="minuteselect">';
                for (l = 0; l < 60; l += this.timePickerIncrement) {
                    var f = l < 10 ? "0" + l : l;
                    m = a.clone().minute(l), p = !1;
                    i && m.second(59).isBefore(i) && (p = !0), s && m.second(0).isAfter(s) && (p = !0), a.minute() != l || p ? e += p ? '<option value="' + l + '" disabled="disabled" class="disabled">' + f + "</option>" : '<option value="' + l + '">' + f + "</option>" : e += '<option value="' + l + '" selected="selected">' + f + "</option>"
                }
                if (e += "</select>", this.timePickerSeconds) {
                    e += '<span class="time-divider">:</span><select class="secondselect">';
                    for (l = 0; l < 60; l++) {
                        f = l < 10 ? "0" + l : l, m = a.clone().second(l), p = !1;
                        i && m.isBefore(i) && (p = !0), s && m.isAfter(s) && (p = !0), a.second() != l || p ? e += p ? '<option value="' + l + '" disabled="disabled" class="disabled">' + f + "</option>" : '<option value="' + l + '">' + f + "</option>" : e += '<option value="' + l + '" selected="selected">' + f + "</option>"
                    }
                    e += "</select> "
                }
                if (!this.timePicker24Hour) {
                    ...
                    var u = "",
                        D = "";
                    i && a.clone().hour(12).minute(0).second(0).isBefore(i) && (u = ' disabled="disabled" class="disabled"'), s && a.clone().hour(0).minute(0).second(0).isAfter(s) && (D = ' disabled="disabled" class="disabled"'), a.hour() >= 12 ? e += '<option value="AM"' + u + '>AM</option><option value="PM" selected="selected"' + D + ">PM</option>" : e += '<option value="AM" selected="selected"' + u + '>AM</option><option value="PM"' + D + ">PM</option>", e += "</select>"
                }
        ...
        elementChanged: function() {
            if (this.element.is("input") && this.element.val().length) {
                var e = this.startDate.clone(),
                    ...
                    s = null,
                    n = null;
                2 === i.length && (s = t(i[0], this.locale.format), n = t(i[1], this.locale.format)), (this.singleDatePicker || null === s || null === n) && (n = s = t(this.element.val(), this.locale.format)), s.isValid() && n.isValid() && (this.isFormatContainsTime || (s.hours(e.hours()).minutes(e.minutes()).seconds(e.seconds()).milliseconds(e.milliseconds()), n.hours(a.hours()).minutes(a.minutes()).seconds(a.seconds()).milliseconds(a.milliseconds())), this.setStartDate(s), this.setEndDate(n), this.updateView())
            }
        },
        keydown: function(t) {
