(function(e) {
    function t(t) {
        for (var i, a, o = t[0], c = t[1], u = t[2], d = 0, _ = []; d < o.length; d++) a = o[d], Object.prototype.hasOwnProperty.call(n, a) && n[a] && _.push(n[a][0]), n[a] = 0;
    ...
    "56d7": function(e, t, s) {
        ...
        var i, n, r = s("2b0e"),
            a = function() {
                ...
                return s("div", {
                    class: {
                        "splash-on": e.showSplash
                    },
                    attrs: {
                        id: "data-exports"
                    }
                }, [e.showSplash ? s("info-splash") : e._e(), s("reports-data-exports", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: !e.showSplash,
            ...
            c = function() {
                ...
                }, [e._m(0), s("h2", [e._v("Export data from your account.")]), s("p", {
                    staticClass: "lead-in"
                }, [e._v("View exports you have generated, or schedule regular reports to be sent.")]), s("p", [s("button", {
                    staticClass: "btn green hide-splash",
                    on: {
                        click: e.continueToReportClick
                    }
                }, [e._v("Continue")])])])
            },
            u = [function() {
            ...
            h = function() {
                ...
                return s("div", {
                ...
                }, [s("DisplayMessage"), s("header", {
                    staticClass: "page-content-header"
                }, [s("h3", {
                    staticClass: "page-title"
                }, [e.displayEdit ? s("span", [s("button", {
                    staticClass: "icon-back",
                    on: {
                        click: e.closeEdit
                    }
                }), e.isAdd ? s("span", [e._v("AddÂ ")]) : s("span", [e._v("EditÂ ")]), e._v("a\n        scheduled email report\n      ")]) : s("span", [s("span", {
                ...
                }, [e._v("\n        Manage and download exported data requested from elsewhere in the App."), s("br"), e._v("\n        Or create and manage up to ten scheduled email reports to your team members.\n      ")])])]), s("div", {
                    staticClass: "modal-container"
                }, [s("div", {
                    staticClass: "modal-dialog modal-medium confirm-exit",
                    class: {
                        "is-active": e.displayClosePopup
                    }
                }, [s("header", {
                    staticClass: "modal-header"
                }, [s("h4", [e._v("Exit without saving?")]), s("button", {
                    ...
                    on: {
                        click: function() {
                            e.setIsSaved(!0), e.setDisplayEdit(!1), e.setCloseAction(!1)
                        }
                    }
                }, [e._v("\n          Exit without saving\n        ")])])]), s("div", {
                    staticClass: "modal-backdrop fade",
                    class: {
                        in: e.displayClosePopup
                    },
                    on: {
                        click: function(t) {
                            e.setIsSaved(!0), e.setCloseAction(!1)
                    ...
                    class: {
                        "reports-active": e.reportsActive
                    }
                }, [e.displayEdit ? e._e() : s("div", {
                    ...
                    staticClass: "tab",
                    class: {
                        "is-active": e.exportsActive
                    },
                    attrs: {
                        disabled: e.exportsActive
                    },
                    on: {
                        click: e.showExports
                    }
                    ...
                    staticClass: "tab",
                    class: {
                        "is-active": e.reportsActive
                    },
                    attrs: {
                        disabled: e.reportsActive
                    },
                    on: {
                        click: e.showReports
                    }
                ...
                }, [e.allowScheduledExport ? s("button", {
                ...
                }, [e._v("\n          Add scheduled report\n        ")]) : e._e()])]), s("DataExportsResultsDisplay", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                    ...
                    ref: "scheduledEdit"
                })], 1), e.fullPageLoad ? s("AjaxLoadingSpinner") : e._e()], 1)
            },
            m = [],
            ...
            S = {
                created: function() {
                    T()(window).on("click.Bst", this.$_mixinTriggerableWindowClicked), this.$eventBus.$on(g.TRIGGERABLE_OPENED, this.$_mixinTriggerableOpened)
                },
                mounted: function() {
                    this.mixinTriggerable_layers = T()(this.$el).find(".mixinTriggerable_layer"), T()(this.$el).hasClass("mixinTriggerable_layer") && this.mixinTriggerable_layers.push(this.$el)
                },
                destroyed: function() {
                    T()(window).off("click.Bst", this.$_mixinTriggerableWindowClicked), this.$eventBus.$off(g.TRIGGERABLE_OPENED, this.$_mixinTriggerableOpened)
                },
                methods: {
                    ...
                    $_mixinTriggerableWindowClicked: function(e) {
                        if (this.mixinTriggerable_ignoreNextWindowClick) this.mixinTriggerable_ignoreNextWindowClick = !1;
                            ...
                            var t = function(e) {
                                    var t = T()(e).parents().filter((function(e, t) {
                    ...
                    mixinTriggerable_forceOpen: function(e) {
                        ...
                        this.mixinTriggerable_isOpen = !0, t || (this.$_mixinTriggerableUpdateParent(this.mixinTriggerable_isOpen), this.mixinTriggerable_ignoreNextWindowClick = !0, this.$eventBus.$emit(g.TRIGGERABLE_OPENED, this.mixinTriggerable_getID()))
                    },
                    mixinTriggerable_forceClose: function(e) {
                        void 0 !== e && e.stopImmediatePropagation(), this.mixinTriggerable_isModal = !1;
                        var t = this.mixinTriggerable_isOpen;
                        this.mixinTriggerable_isOpen = !1, t && (this.$_mixinTriggerableUpdateParent(this.mixinTriggerable_isOpen), this.mixinTriggerable_ignoreNextWindowClick = !0, this.$eventBus.$emit(g.TRIGGERABLE_CLOSED, this.mixinTriggerable_getID()))
                    }
                },
                props: {
            ...
            I = (s("7f45"), {
                methods: {
                    getUnixSecsRangeByDays: function(e, t) {
                        ...
                        var n = 60 * i._offset,
                            r = 0;
                        return e > 0 && (r = y.a.utc().subtract(e, "days").startOf("day").unix() + n), {
                            start: r,
                            end: y.a.utc().endOf("day").unix() + n
                        }
                    },
        ...
        function R(e, t) {
            return Object(U["a"])(t, (function(t, s, i) {
                return t[i] = Object(U["a"])(s, (function(t, s, i) {
        ...
        var x, j, N, G = "root/",
            ...
            $ = (i = {}, Object(f["a"])(i, L.getters.GET_IS_AJAX_RUNNING, (function(e) {
            ...
            F = (n = {}, Object(f["a"])(n, L.mutations.SET_CSRF_KEY, (function(e, t) {
                e.csrf_key = t
            ...
            B = Object(f["a"])({}, L.actions.UPDATE_SUCCESS_MESSAGE, (function(e, t) {
                ...
                e.commit(L.mutations.SET_SUCCESS_MESSAGE, s), setTimeout((function() {
            ...
            W = {
                getters: {
                    ...
                    GET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE: Q + "GET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE",
                    GET_EDIT_INCLUDE_USERNAMES_FUTURE: Q + "GET_EDIT_INCLUDE_USERNAMES_FUTURE",
                ...
                mutations: {
                    ...
                    SET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE: Q + "SET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE",
                    SET_EDIT_INCLUDE_USERNAMES_FUTURE: Q + "SET_EDIT_INCLUDE_USERNAMES_FUTURE",
            ...
            X = [{
                ...
                id: "clicked",
                title: "Link clicked by recipient",
                checked: !0
            }],
            K = [{
                id: "bounce",
            ...
            ee = (x = {}, Object(f["a"])(x, J.getters.GET_EDIT_ID, (function(e) {
                return e.edit_id
            ...
            })), Object(f["a"])(x, J.getters.GET_EDIT_INCLUDE_USERNAMES_FUTURE, (function(e) {
            ...
            })), Object(f["a"])(x, J.getters.GET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE, (function(e) {
                ...
                return 0 === e.edit_name.length || 0 === e.edit_usernames.length || 0 === e.edit_subaccounts.length || 0 === e.edit_recipients.length || ("activity" == e.edit_origin && 0 === e.edit_activity_events.length || ("suppressions" == e.edit_origin && 0 === e.edit_suppression_events.length || e.is_saved))
            ...
            te = (j = {}, Object(f["a"])(j, J.mutations.SET_EDIT_ID, (function(e, t) {
                e.edit_id = t
            })), Object(f["a"])(j, J.mutations.SET_EDIT_ORIGIN, (function(e, t) {
                e.edit_origin = t, e.is_saved = !1
            })), Object(f["a"])(j, J.mutations.SET_EDIT_SUMMARY_GROUP_BY, (function(e, t) {
                ...
                void 0 == t || null == t ? (e.edit_activity_events = X, e.edit_suppression_events = K) : "activity" == e.edit_origin ? (e.edit_suppression_events = K, e.edit_activity_events = [], X.forEach((function(s) {
                    s.checked = t.includes(s.id), e.edit_activity_events.push(s)
                }))) : "suppressions" == e.edit_origin && (e.edit_activity_events = X, e.edit_suppression_events = [], K.forEach((function(s) {
                    s.checked = t.includes(s.id), e.edit_suppression_events.push(s)
                })))
            })), Object(f["a"])(j, J.mutations.TOGGLE_EDIT_ACTIVITY_EVENT, (function(e, t) {
                if (null == t) {
                    var s = !0;
                    ...
                    n.checked = !e.edit_activity_events[i].checked, r["a"].set(e.edit_activity_events, i, n)
                }
                e.is_saved = !1
            })), Object(f["a"])(j, J.mutations.TOGGLE_EDIT_SUPPRESSION_EVENT, (function(e, t) {
                if (null == t) {
                    var s = !0;
                    e.edit_suppression_events.forEach((function(e) {
                        e.checked || (s = !1)
                    })), e.edit_suppression_events.forEach((function(t, i) {
                        t.checked = !s, r["a"].set(e.edit_suppression_events, i, t)
                    }))
                } else {
                    ...
                    n.checked = !e.edit_suppression_events[i].checked, r["a"].set(e.edit_suppression_events, i, n)
                }
                e.is_saved = !1
                ...
                e.edit_recipients.length < 50 && (e.edit_recipients.push(t), e.is_saved = !1)
                ...
                void 0 == t || null == t || 0 == t.length ? (e.edit_usernames = [], e.usernames.forEach((function(t) {
                    t.checked = !0, e.edit_usernames.push(t)
                }))) : (e.edit_usernames = [], e.usernames.forEach((function(s) {
                    s.checked = t.includes(s.username), e.edit_usernames.push(s)
                })))
            })), Object(f["a"])(j, J.mutations.SET_EDIT_INCLUDE_USERNAMES_FUTURE, (function(e, t) {
                e.edit_include_usernames_future = t
            })), Object(f["a"])(j, J.mutations.SET_EDIT_OPTIONAL_ATTACHMENT, (function(e, t) {
                e.edit_optional_attachment = t
            })), Object(f["a"])(j, J.mutations.SET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE, (function(e, t) {
                ...
                i.checked = !e.edit_usernames[s].checked, r["a"].set(e.edit_usernames, s, i), e.is_saved = !1
                ...
                e.edit_usernames.forEach((function(e) {
                    ...
                    t.test(i.username) || (i.checked = !s, r["a"].set(e.edit_usernames, n, i))
                })), e.is_saved = !1
                ...
                void 0 == t || null == t || 0 == t.length ? (e.edit_subaccounts = [], e.subaccounts.forEach((function(t) {
                    t.checked = !0, e.edit_subaccounts.push(t)
                }))) : (e.edit_subaccounts = [], e.subaccounts.forEach((function(s) {
                    s.checked = t.includes(s.record_id), e.edit_subaccounts.push(s)
                })))
                ...
                if (null == t) {
                    ...
                    n.checked = !e.edit_subaccounts[i].checked, r["a"].set(e.edit_subaccounts, i, n)
                }
                e.is_saved = !1
                ...
                e.close_action = t
            })), Object(f["a"])(j, J.mutations.SET_ALLOW_SCHEDULED_EXPORT, (function(e, t) {
                ...
                })), e.edit_include_usernames_future = !0, e.edit_include_subaccounts_future = !0
            })), j),
            se = (N = {}, Object(f["a"])(N, J.actions.FETCH_USERNAMES, (function(e) {
                return new Promise((function(t, s) {
                    V.post(e.rootGetters[P.getters.GET_BACKEND_URL]("Data Exports", "load-username")).then((function(s) {
                        e.commit(J.mutations.SET_USERNAMES, s.results.usernames), e.commit(J.mutations.SET_SUBACCOUNTS, s.results.subaccounts), t(s)
                    })).catch((function(t) {
                        e.commit("root/SET_ERROR_MESSAGE", t, {
                            root: !0
                        }), s(t)
                    }))
                }))
                ...
                return new Promise((function(t, s) {
                    V.post(e.rootGetters[P.getters.GET_BACKEND_URL]("Data Exports", "create-schedule"), {
                        ...
                        usernames_include_future: e.getters.GET_EDIT_INCLUDE_USERNAMES_FUTURE,
                        subaccounts_include_future: e.getters.GET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE,
                        optional_attachment: e.getters.GET_EDIT_OPTIONAL_ATTACHMENT
                    }).then((function() {
                        return t(e.dispatch("root/UPDATE_SUCCESS_MESSAGE", {
                            success_message: "Successfully created scheduled email report."
                        }, {
                            root: !0
                        }))
                    })).catch((function(t) {
                ...
                return new Promise((function(t, s) {
                    V.put(e.rootGetters[P.getters.GET_BACKEND_URL]("Data Exports", "update-schedule"), {
                        ...
                        return t(e.dispatch("root/UPDATE_SUCCESS_MESSAGE", {
                            success_message: "Successfully updated scheduled email report."
                        }, {
                            root: !0
                        }))
                    })).catch((function(t) {
            ...
            ae = {
                ...
                created: function() {
                    this.makeRequest = function(e, t, s, i, n, r, a) {
                        void 0 !== a && null !== a || (a = !1);
                        var o = this;
                        T.a.ajax(END_POINTS.urls()[t] + "?action=" + encodeURIComponent(s) + "&CSRF_key=" + encodeURIComponent(HTML.csrfkey), {
                            method: e,
                            data: i,
                            complete: function(e, t) {
                                if ("success" != t) {
                                    ...
                                    a || o.$store.commit("runningAjaxRequestsDecrement");
                                    try {
                                        "error" in e.responseJSON && o.s2g_objectIsFunction(r) ? r(e) : o.s2g_objectIsFunction(n) && n(e)
                                    } catch (s) {
                                        console.error("encountered error in AJAXBackendMixin, err:", s)
                                    }
                                }
            ...
            le = function() {
                ...
                return s("div", {
                ...
                }, [e.shouldShow ? s("table", {
                    staticClass: "dataTable table table-striped table-hover display loading-in",
                    class: {
                        "no-results": 0 == e.numDataExports
                    },
                    attrs: {
                        id: "bounce-dtable"
                    }
                    ...
                    class: {
                        "has-long-date": e.hasLongDate
                    }
                }, [s("tr", e._l(e.displayColumns, (function(t) {
                    return s("th", {
                        key: t.id,
                        class: "table-" + t.id
                    }, [e._v(e._s(t.label))])
                })), 0)]), s("tbody", [e._l(e.dataExportsResults, (function(t, i) {
                    return s("tr", {
                        key: i,
                        ...
                        return s("td", {
                            ...
                            staticClass: "date"
                        }, [e._v(e._s(t[i.id].date) + "Â ")]) : e._e(), s("span", {
                            class: t[i.id].timeClass
                        }, [e._v(e._s(t[i.id].time))])]) : "download" === i.id ? s("div", {
                        ...
                        }), s("span", [e._v("Download")])])]) : e._e(), e.showRetry(t) ? s("li", {
                            staticClass: "retry",
                            on: {
                                click: function(s) {
                                    return e.markForRetry(t)
                                }
                            }
                        }, [e._m(0, !0)]) : e._e(), e._m(1, !0)]) : e._e(), s("ul", {
                            staticClass: "dropdown-menu confirm-remove"
                        }, [s("li", [s("span", {
                            staticClass: "tooltip-title"
                        }, [e._v("Confirm remove?")]), s("a", {
                            ...
                            on: {
                                click: function(s) {
                                    return e.deleteExport(t)
                                }
                            }
                        }, [e._v("Remove")]), s("a", {
                            staticClass: "table-remove-close toggle-popup",
                            on: {
                                click: e.hideAllPopup
                            }
                        }, [e._v("Cancel")])])]), t.displayPopup ? s("div", {
                            staticClass: "mobile-only-backdrop",
                            on: {
                                click: e.hideAllPopup
                            }
                        }) : e._e()]) : s("span", [e._v(e._s(t[i.id]))])])
                    })), 0)
                })), e.requestActive || 0 != e.numDataExports ? e._e() : s("tr", {
            ...
            de = [function() {
                ...
                return s("li", {
                    ...
                    staticClass: "trigger-remove"
                }, [s("span", {
                    staticClass: "icon-remove"
                }, [e._v("Ã—")]), s("span", [e._v("Remove")])])])
            }, function() {
                var e = this,
                    t = e.$createElement,
                    s = e._self._c || t;
            ...
            _e = {
                ...
                methods: {
                    markForRetry: function(e) {
                        ...
                        this.hideAllPopup(), T()(".notice.main.error").empty().removeClass("visible"), this.mixinAjax_put(this.requestPoint, "retry", s, (function(e) {
                            HTML.set_time(e.responseJSON), t.$eventBus.$emit("mixin-search-has-changed"), t.$eventBus.$emit("mixin-search-trigger")
                        }), (function(e) {
                            HTML.handleError(e.responseJSON)
                        }))
                    },
                    showRetry: function(e) {
                        return !("zip" !== e.datatype && "tar" !== e.datatype || !e.failed)
                    },
                    showDownload: function(e) {
                        return !!("zip" !== e.datatype && "tar" !== e.datatype || e.completed)
                    },
                    initDataExportsResultsDisplay: function(e) {
                        this.id = e, this.initialised = !0
                    },
                    updateDataExportsResults: function(e, t) {
                        this.dataExportsResults = e, this.hasLongDate = t, null !== this.id && this.forceDownload()
                    },
                    forceDownload: function() {
                        for (var e = 0; e < this.dataExportsResults.length; e++)
                            if (this.dataExportsResults[e].id === this.id) {
                                var t = document.createElement("a");
                                t.href = this.dataExportsResults[e].download_url, document.body.appendChild(t), t.click(), document.body.removeChild(t), this.id = null;
                                break
                            }
                    },
                    deleteExport: function(e) {
                        ...
                        this.hideAllPopup(), T()(".notice.main.error").empty().removeClass("visible"), this.mixinAjax_delete(this.requestPoint, "", s, (function(e) {
                            HTML.set_time(e.responseJSON), t.$eventBus.$emit("mixin-search-has-changed"), t.$eventBus.$emit("mixin-search-trigger")
                        }), (function(e) {
                            HTML.handleError(e.responseJSON)
                        }))
                    ...
                    windowClicked: function(e) {
                        ...
                        screen.width < 768 && (t = ".data-exports-result-wrapper"), T()(e.target).parents(t).length || (this.hideAllPopup(), T()(".data-exports-popup").removeClass("popup-on"))
                    }
                },
                computed: {
                    ...
                    isFullDateInResults: function() {
                        var e = !1;
                        return this.dataExportsResults.forEach((function(t) {
                            t.date_display.hideDate || (e = !0)
                        })), e
                    }
                },
                mounted: function() {
                    T()(".page-content-wrapper .page-content").on("click.Bst", this.windowClicked)
                }
            };
        T()(document).on("click", ".row-options-toggle", (function() {
            T()(this).parents(".data-exports-popup").toggleClass("popup-on"), T()(".row-options").hasClass("is-active") ? setTimeout((function() {
                T()(this).removeClass("popup-active"), T()(".row-options").removeClass("is-active")
            }), 10) : setTimeout((function() {
                T()(this).addClass("popup-active"), T()(".row-options").addClass("is-active")
            }), 10)
        })), T()(document).on("click", ".trigger-remove", (function() {
            T()(".row-options").removeClass("is-active"), T()(this).parents(".data-exports-popup").find(".confirm-remove").addClass("is-activated")
        }));
        var Ee = _e,
            ...
            me = function() {
                ...
                return s("div", {
                    staticClass: "tab-container"
                }, [e.allowScheduledExport ? e._e() : s("TabSplash"), e.allowScheduledExport ? s("table", {
                    staticClass: "dataTable table table-striped table-hover display loading-in",
                    class: {
                ...
                }, [s("thead", [s("tr", [e._l(e.activeColumns, (function(t) {
                    return s("th", {
                        key: t.id,
                        class: "table-" + t.id
                    }, [e._v("\n          " + e._s(t.label) + "\n        ")])
                    ...
                    staticClass: "dropdown-menu dropdown-options column-filter mixinTriggerable_layer",
                    class: {
                ...
                }, [e._m(0), e._l(e.columnFilters, (function(t) {
                    return s("li", {
                        key: t.id,
                ...
                }))], 2)])])], 2)]), s("tbody", [e._l(e.scheduledResults, (function(t) {
                    return s("tr", {
                        key: t.id,
                        class: "format-" + t.datatype
                    }, [s("td", {
                        staticClass: "table-name"
                    }, [e.canDeleteAny || e.username == t.author ? s("button", {
                    ...
                    }, [e._v("\n            " + e._s(t.description) + "\n          ")]) : s("span", [e._v(e._s(t.description))])]), s("td", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                    ...
                    }, [e._v("\n          " + e._s(t.origin.replace("summary-overview", "summary breakdown")) + "\n        ")]), s("td", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                    ...
                    }, [e._v("\n          " + e._s(e.displayFrequency(t.schedule_report_frequency)) + "\n        ")]), s("td", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                    ...
                    }, [s("span", [e._v(e._s(e.displayDataType(t.datatype)))])]), s("td", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.isColumnActive("recipients"),
                            expression: "isColumnActive('recipients')"
                        }],
                        staticClass: "text-nowrap cell-recipients cell-team"
                    }, [s("div", {
                        staticClass: "cell-team-content"
                    }, [s("div", {
                        staticClass: "text-align"
                    }, e._l(t.scheduled_export_recipients, (function(t) {
                        return s("span", {
                            key: t,
                            class: e.getRecipientColourClass(t)
                        }, [s("span", {
                            staticClass: "member-initials"
                        }, [e._v("\n                  " + e._s(e.getRecipientInitial(t)) + "\n                ")]), s("span", {
                            staticClass: "member-details"
                        }, [s("span", {
                            staticClass: "member-username"
                        }, [e._v(e._s(e.getRecipientName(t)))]), s("span", {
                            staticClass: "member-email"
                        }, [e._v(e._s(e.getRecipientAddress(t)))])])])
                    })), 0)])]), s("td", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                    ...
                    }, [s("span", [e._v(e._s(t.author))])]), s("td", {
                        staticClass: "cell-tools dropdown-action-cell"
                    }, [e.canDeleteAny || e.username == t.author ? s("div", {
                        staticClass: "drop-content row-delete-popup"
                    }, [s("a", {
                        staticClass: "dropdown-action-toggler table-remove-toggler row-remove-toggler"
                    }, [e._v("Ã—")]), s("ul", {
                        ...
                        on: {
                            click: function(s) {
                                return e.deleteExport(t.id)
                            }
                        }
                    }, [s("span", [e._v("Remove")])]), s("a", {
                        staticClass: "dropdown-action-toggler table-remove-cancel",
                        attrs: {
                            href: "#"
                        }
                    }, [e._v("Cancel")])])])]) : e._e()])])
                })), 0 == e.numDataExports ? s("tr", {
                    staticClass: "no-results"
                }, [e._m(1)]) : e._e()], 2)]) : e._e()], 1)
            },
            fe = [function() {
                var e = this,
                    t = e.$createElement,
                    s = e._self._c || t;
                return s("li", [s("p", [s("strong", [e._v("Display optional columns")]), s("br"), e._v("Choose to show\n                  optional columns\n                ")])])
            }, function() {
                var e = this,
                    t = e.$createElement,
                    s = e._self._c || t;
            ...
            ge = function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("div", {
                    staticClass: "tab-splash-container"
                }, [s("div", {
                    staticClass: "tab-splash"
                }, [e._m(0), s("div", {
                    staticClass: "tab-splash-content"
                }, [s("div", {
                    staticClass: "content-label"
                }, [e._v("Available to paid accounts")]), s("h3", [e._v("Automatic email-based reports of your account data")]), s("p", [e._v("Track your SMTP2GO account activity right from your inbox. Choose your page source and events youâ€™d like to track, then send automated reports to email recipients of your choosing.")]), e.hidePaymentSplash ? e._e() : s("a", {
                    staticClass: "green btn",
                    attrs: {
                        href: "/account/changeplan/"
                    }
                }, [e._v("See Upgrade Options"), s("span", {
        ...
        function Ce(e) {
            for (var t = 1; t < arguments.length; t++) {
                ...
                t % 2 ? be(Object(s), !0).forEach((function(t) {
                    Object(f["a"])(e, t, s[t])
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(s)) : be(Object(s)).forEach((function(t) {
        ...
        function we(e) {
            for (var t = 1; t < arguments.length; t++) {
                var s = null != arguments[t] ? arguments[t] : {};
                t % 2 ? Oe(Object(s), !0).forEach((function(t) {
                    Object(f["a"])(e, t, s[t])
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(s)) : Oe(Object(s)).forEach((function(t) {
                    Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(s, t))
                }))
            }
            return e
        ...
        var Ue = {
            ...
            methods: we(we({}, Object(w["d"])({
                ...
                setIncludeUsernamesFuture: W.mutations.SET_EDIT_INCLUDE_USERNAMES_FUTURE,
                setIncludeSubaccountsFuture: W.mutations.SET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE,
                ...
                updateScheuldedResults: function(e) {
                    ...
                    })), this.scheduledResults = e, 0 == e.length && (this.noResults = !0)
                },
                toggleReport: function(e) {
                    this.setEditId(e.id), this.setEditOrigin(e.origin);
                    var t = e.summary_group_by;
                    void 0 == t && (t = "auth"), this.setEditSummaryGroupBy(t), this.setEditName(e.description), this.setEditFrequency(e.schedule_report_frequency), this.setEditDatatype(e.datatype), this.setEditRecipients(e.scheduled_export_recipients), this.setEditEvents(), void 0 != e.filter_events && e.filter_events.length > 0 && this.setEditEvents(e.filter_events), void 0 != e.events && e.events.length > 0 && this.setEditEvents(e.events), this.setEditUsernames(e.usernames), this.setEditSubaccounts(e.subaccounts), this.setIsCreate(!1), this.setIsSaved(!0), this.setDisplayEdit(!0), this.setIsAdd(!1), this.setIncludeUsernamesFuture(void 0 == e.usernames || 0 == e.usernames.length), this.setIncludeSubaccountsFuture(void 0 == e.subaccounts || 0 == e.subaccounts.length), this.setEditOptionalAttachment(e.optional_attachment)
                },
                windowClicked: function(e) {
                    var t = ".dropdown-action-cell";
                    screen.width < 768 && (t = ".row-delete-result-wrapper"), T()(e.target).parents(t).length || T()(".dropdown-menu").removeClass("is-active")
                },
                ...
                deleteExport: function(e) {
                    ...
                    T()(".notice.main.error").empty().removeClass("visible"), T()(".dropdown-menu.dropdown-options.is-active").removeClass("is-active"), this.mixinAjax_delete(this.requestPoint, "delete-schedule", s, (function() {
                        HTML.set_time({
                            message: "Successfully deleted scheduled report",
                            message_class: "success",
                            status: "OK"
                        }), t.$eventBus.$emit("mixin-search-has-changed"), t.$eventBus.$emit("mixin-search-trigger")
                    }), (function(e) {
                        HTML.handleError(e.responseJSON)
                    }))
                },
                buildDescription: function(e) {
                    var t, s = "";
                    if (void 0 != e.events && e.events.length > 0 && (t = e.events), void 0 != e.filter_events && e.filter_events.length > 0 && (t = e.filter_events), void 0 != t && t.length > 0) {
                    ...
                    return void 0 != e.scheduled_export_recipients && e.scheduled_export_recipients.length > 0 && (s += e.scheduled_export_recipients.join(", ")), s
                },
                ...
                getRecipientInitial: function(e) {
                    return this.getRecipientName(e).match(/(\b\S)?/g).join("").match(/(^\S|\S$)?/g).join("").toUpperCase()
                },
                getRecipientColourClass: function(e) {
                    var t = this.activeMemberNames[e];
                    return null != t ? "member-color-" + this.activeMemberNames[e].colour_id : ""
                },
                ...
                handleColumnToggle: function(e, t) {
                    ...
                    this.$set(this.shownColumns, t.id, !s), this.$set(t, "active", !s), this.checkIfFormatOnly(), this.$eventBus.$emit("mixin-column-has-changed"), this.saveColumn()
                },
            ...
            mounted: function() {
                var e = this;
                T()(".page-content-wrapper .page-content").on("click.Bst", this.windowClicked), this.$config.exportDisplayColumns.forEach((function(t) {
                    var s = "show_data_export_" + t["id"] + "_col";
                    void 0 != PAGE_DATA.apMetadata && "app_settings" in PAGE_DATA.apMetadata && s in PAGE_DATA.apMetadata.app_settings && e.$set(t, "active", PAGE_DATA.apMetadata.app_settings[s]), e.$set(e.shownColumns, t["id"], t["active"])
                })), this.checkIfFormatOnly()
            }
        };
        T()(document).on("click", ".dropdown-action-toggler", (function() {
            var e = T()(this);
            e.parents(".dropdown-action-cell").toggleClass("popup-on"), T()(".dropdown-options").hasClass("is-active") ? setTimeout((function() {
                e.removeClass("popup-active"), T()(".dropdown-options").removeClass("is-active")
            }), 10) : setTimeout((function() {
                e.addClass("popup-active"), e.parents(".dropdown-action-cell").find(".dropdown-options").addClass("is-active")
            }), 10)
        }));
        var Re = Ue,
            ...
            je = function() {
                ...
                return s("div", {
                ...
                }, [e._v("Report data will appear as it is displayed on the selected\n              page.")]), s("span", {
                    ...
                    staticClass: "field-info"
                }, [e._v("Give your report a descriptive name to help you locate it from\n            your list of scheduled reports.")]), s("span", {
                    staticClass: "field-error",
                    staticStyle: {
                        display: "none"
                    }
                }, [e._v("error test")])])]), "summary" == e.selectedOrigin ? s("div", {
                    staticClass: "form-group"
                }, [s("label", {
                    staticClass: "form-group-label"
                }, [e._v("Filter")]), s("div", {
                    ...
                    on: {
                        change: [function(t) {
                            ...
                            e.summaryGroupBy = t.target.multiple ? s : s[0]
                        }, function(t) {
                            return e.selectAll()
                        }]
                    }
                ...
                })])])]) : e._e(), "activity" == e.selectedOrigin || "suppressions" == e.selectedOrigin ? s("div", {
                    staticClass: "form-group"
                }, [s("label", {
                    staticClass: "form-group-label"
                }, [e._v("Events to include")]), s("div", {
                    staticClass: "form-group-item"
                }, [s("div", {
                    ref: "eventsDropdownContainer",
                    staticClass: "labels-dropdown-container labels-events",
                    on: {
                        focusout: function(t) {
                    ...
                    staticClass: "labels-active form-select-wrapper",
                    class: {
                        "is-focus": e.isEventsFocused
                    },
                    attrs: {
                        tabindex: "0"
                    },
                    on: {
                        ...
                        keyup: [function(t) {
                            ...
                            return !t.type.indexOf("key") && e._k(t.keyCode, "down", 40, t.key, ["Down", "ArrowDown"]) ? null : e.openDropdown("event")
                        }]
                    }
                    ...
                    return s("li", {
                        ...
                        class: ["item-label", "long-event-indicator", t.id]
                    }, [s("span", {
                ...
                })), 0 === e.selectedEvents.length ? s("li", {
                    ...
                    ref: "dropdown",
                    staticClass: "labels-dropdown labels-checkbox",
                    class: {
                        "is-active": e.eventsDropdownActive
                    },
                    on: {
                        click: e.handleClickInsideDropdown
                    }
                }, [s("li", {
                    staticClass: "indicators-filter toggle-all",
                    attrs: {
                        tabindex: e.eventsDropdownActive ? "0" : "-1"
                    },
                    on: {
                        click: function(t) {
                ...
                }, [e._v(e._s("checked" === e.eventsCheckboxState ? "Deselect all" : "Select all"))])])]), e._l(e.editEvents, (function(t) {
                    return s("li", {
                        key: t.id,
                        ref: "dropdownItem",
                        refInFor: !0,
                        ...
                        on: {
                            ...
                            keydown: function(s) {
                                return !s.type.indexOf("key") && e._k(s.keyCode, "enter", 13, s.key, "Enter") ? null : e.toggleEvent(t)
                            }
                        }
                    }, [s("div", {
                    ...
                    staticClass: "field-info"
                }, [e._v("Select the events to be included in this scheduled report.")])])]) : e._e(), "activity" == e.selectedOrigin || "summary" == e.selectedOrigin && "auth" == e.selectedSummaryGroupBy ? s("div", {
                    staticClass: "form-group"
                }, [s("label", {
                    staticClass: "form-group-label"
                }, [e._v(e._s(e.subaccountsLabel))]), s("div", {
                    staticClass: "form-group-item"
                }, [s("div", {
                    ref: "usersDropdownContainer",
                    staticClass: "form-control input-inline labels-dropdown-container tags-email",
                    class: [{
                        "is-focus": e.isUsersFocused
                    }, {
                        "is-warning": 0 === e.selectedUsersCount && !e.usersDropdownActive
                    }],
                    attrs: {
                        tabindex: "0"
                    },
                    on: {
                        ...
                        keyup: [function(t) {
                            return !t.type.indexOf("key") && e._k(t.keyCode, "enter", 13, t.key, "Enter") ? null : e.toggleUsersDropdown(t)
                        }, function(t) {
                            return !t.type.indexOf("key") && e._k(t.keyCode, "down", 40, t.key, ["Down", "ArrowDown"]) ? null : e.openDropdown("user")
                        }]
                    }
                }, [s("div", {
                    ...
                    staticClass: "form-select-wrapper recipients-active"
                }, [s("li", {
                    staticClass: "dropdown-placeholder"
                }, [e._v(e._s(e.userSelectionText))]), s("li", {
                    staticClass: "dropdown-hotspot",
                    on: {
                        click: e.toggleUsersDropdown
                    }
                })]), e.selectedUsernames.length > 0 ? s("ul", {
                    ref: "usersDropdown",
                    staticClass: "labels-dropdown labels-checkbox",
                    class: {
                ...
                }, [e._m(0), e.selectedSubaccounts.length > 1 ? s("li", {
                    staticClass: "indicators-filter toggle-all toggle-global",
                    on: {
                        click: e.toggleAllUsers
                    }
                }, [s("div", {
                    staticClass: "event-indicator default"
                }, [s("div", {
                    ...
                    staticClass: "checker-box",
                    class: e.overallUsersCheckboxState
                }, [s("input", {
                    attrs: {
                        type: "checkbox",
                        name: "toggle-all",
                    ...
                    staticClass: "indicator-copy toggle-copy"
                }, [e._v(e._s("checked" === e.overallUsersCheckboxState ? "Deselect all" : "Select all"))])])]) : e._e(), e._l(e.selectedSubaccounts, (function(t) {
                    return s("li", {
                        key: t.record_id
                    }, [s("ul", [s("li", {
                        class: {
                        ...
                        attrs: {
                            tabindex: e.usersDropdownActive ? "0" : "-1"
                        },
                        on: {
                            click: function(s) {
                            ...
                            keydown: function(s) {
                                return !s.type.indexOf("key") && e._k(s.keyCode, "enter", 13, s.key, "Enter") ? null : e.toggleSubaccount(t)
                            }
                        }
                    }, [s("div", {
                        staticClass: "event-indicator default"
                        ...
                        class: {
                            "checker-box": !0,
                            checked: "checked" === e.subaccountCheckboxState(t),
                            indeterminate: "indeterminate" === e.subaccountCheckboxState(t)
                        }
                    }, [s("input", {
                        attrs: {
                            type: "checkbox"
                    ...
                    })])]), s("span", [e.selectedSubaccounts.length > 1 ? s("span", [e._v(e._s(t.name))]) : s("span", [e._v("Select All")])])]), e.hasNoUsers(t.record_id) ? s("div", {
                        staticClass: "indicators-filter-info"
                    }, [s("em", [e._v("No users currently in this subaccount")])]) : e._e()]), e._l(e.smtpUsersFiltered(t.record_id), (function(t) {
                        return s("li", {
                            key: t.username,
                            ...
                            on: {
                                click: function(s) {
                                    return e.toggleUsername(t)
                                },
                                keydown: function(s) {
                                    return !s.type.indexOf("key") && e._k(s.keyCode, "enter", 13, s.key, "Enter") ? null : e.toggleUsername(t)
                                }
                            }
                        }, [s("div", {
                            staticClass: "event-indicator default"
                    ...
                    })), e._l(e.ipUsersFiltered(t.record_id), (function(t) {
                        return s("li", {
                            key: t.username,
                            ref: "IPsDropdownItem",
                            refInFor: !0,
                    ...
                    })), e._l(e.apiUsersFiltered(t.record_id), (function(t) {
                        return s("li", {
                            key: t.username,
                    ...
                    staticClass: "field-info"
                }, [e._v("\n            Select the"), e.selectedSubaccounts.length > 1 ? s("span", [e._v(" subaccounts and")]) : e._e(), e._v("Â users to be included in this scheduled report.\n          ")]), s("div", {
                    staticClass: "form-group-options"
                }, [e.selectedSubaccounts.length > 1 ? s("div", {
                    staticClass: "event-indicator default",
                    class: {
                        disabled: !e.allSubaccountsChecked
                    },
                    on: {
                        click: function(t) {
                            e.subaccountsIncludeFuture = !e.subaccountsIncludeFuture
                        }
                    }
                }, [s("div", {
                    staticClass: "checker"
                    ...
                    class: {
                        "checker-box": !0,
                        checked: e.allSubaccountsChecked && e.subaccountsIncludeFuture
                    }
                }, [s("input", {
                    attrs: {
                        type: "checkbox"
                    ...
                    staticClass: "event-indicator default",
                    class: {
                        disabled: !e.allUsersChecked
                    },
                    on: {
                        click: function(t) {
                            e.usernamesIncludeFuture = !e.usernamesIncludeFuture
                        }
                    }
                }, [s("div", {
                    staticClass: "checker"
                    ...
                    class: {
                        "checker-box": !0,
                        checked: e.allUsersChecked && e.usernamesIncludeFuture
                    }
                }, [s("input", {
                    attrs: {
                        type: "checkbox"
                ...
                })])]) : e._e(), e.selectedSubaccounts.length > 1 && "summary" == e.selectedOrigin && "auth" != e.selectedSummaryGroupBy && "subaccount" != e.selectedSummaryGroupBy ? s("div", {
                    staticClass: "form-group"
                }, [s("label", {
                    staticClass: "form-group-label"
                }, [e._v("Subaccounts")]), s("div", {
                    staticClass: "form-group-item"
                }, [s("div", {
                    ref: "usersDropdownContainer",
                    staticClass: "form-control input-inline labels-dropdown-container tags-email",
                    class: [{
                        ...
                        "is-warning": 0 === e.selectedSubaccounts.filter((function(e) {
                            return e.checked
                    ...
                    staticClass: "dropdown-placeholder"
                }, [e._v(e._s(e.subaccountSelectionText))]), s("li", {
                    staticClass: "dropdown-hotspot",
                    on: {
                        click: e.toggleUsersDropdown
                    }
                    ...
                    staticClass: "indicator-copy toggle-copy"
                }, [e._v(e._s("checked" === e.overallUsersCheckboxState ? "Deselect all" : "Select all"))])])]), e._l(e.selectedSubaccounts, (function(t) {
                    return s("li", {
                        key: t.record_id,
                        class: {
                            "indicators-filter-main": !0,
                    ...
                    })])]), s("span", [s("span", [e._v(e._s(t.name))])])])])
                }))], 2)])]), s("span", {
                    staticClass: "field-info"
                    ...
                    staticClass: "form-group-label"
                }, [e._v("Recipients")]), s("div", {
                    staticClass: "form-group-item"
                }, [s("div", {
                    ref: "recipientsDropdownContainer",
                    staticClass: "form-control input-inline labels-dropdown-container tags-email",
                    class: {
                        "is-focus": e.isFocused
                    },
                    attrs: {
                        tabindex: "0"
                    },
                    on: {
                        ...
                        keyup: [function(t) {
                            return !t.type.indexOf("key") && e._k(t.keyCode, "enter", 13, t.key, "Enter") ? null : e.toggleRecipientsDropdown(t)
                        }, function(t) {
                            return !t.type.indexOf("key") && e._k(t.keyCode, "down", 40, t.key, ["Down", "ArrowDown"]) ? null : e.openDropdown("recipient")
                        }]
                    }
                }, [s("div", {
                    ...
                    return s("li", {
                        ...
                        staticClass: "long-event-indicator item-label recipient"
                    }, [e._v("\n                    " + e._s(t) + "\n                    "), s("span", {
                        staticClass: "item-delete",
                        on: {
                            click: function(t) {
                    ...
                    staticClass: "dropdown-hotspot",
                    on: {
                        click: e.toggleRecipientsDropdown
                    }
                })], 2), s("ul", {
                    ...
                    return s("li", {
                        ...
                        refInFor: !0,
                        attrs: {
                            tabindex: e.recipientsDropdownActive ? "0" : "-1"
                        },
                        on: {
                            click: function(s) {
                            ...
                            keydown: function(s) {
                                return !s.type.indexOf("key") && e._k(s.keyCode, "enter", 13, s.key, "Enter") ? null : e.addRecipient(t)
                            }
                        }
                    }, [e._v("\n                  " + e._s(t) + "\n                ")])
                })), 0)])]), s("span", {
                    ...
                    class: {
                        "field-info-tooltip": e.isNotOwner
                    }
                }, [e._v("available team members")]), e.isNotOwner ? s("span", {
                    staticClass: "tooltip-baloon"
                }, [e._v("You can only add team members with a specific level (" + e._s(e.actingRoleLevel) + ") or below to scheduled reports. If you'd like to include\n                team members with a higher level, the report must be created\n                by someone with that particular level.")]) : e._e()]), e._v("\n            who will receive this scheduled report at the frequency specified\n            below.\n          ")]), s("span", {
                    staticClass: "field-error",
                    staticStyle: {
                        display: "none"
                    }
                    ...
                    staticClass: "info-highlight"
                }, [e._v("\n                " + e._s(e.frequencyText) + ", around 00:30:00 UTC" + e._s(e.scheduleTime) + ",\n                and include data from the previous" + e._s(e.frequencySize) + ".")])]), s("span", {
                    staticClass: "field-error",
                    staticStyle: {
                        display: "none"
                    }
                    ...
                    staticClass: "field-info"
                }, [e._v("Choose the data format for your report.")]), s("span", {
                    staticClass: "field-error",
                    staticStyle: {
                        display: "none"
                    }
                    ...
                    staticClass: "form-group-label"
                }, [e._v("Attachment")]), s("div", {
                    staticClass: "form-group-content"
                }, [s("div", {
                    staticClass: "form-group-item"
                }, [s("div", {
                    staticClass: "wrapper-small"
                }, [s("div", {
                    staticClass: "event-indicator default",
                    on: {
                        click: function(t) {
                ...
                }, [e._v("The exported file will also be attached to the report email.")])])]), s("span", {
                    staticClass: "field-error",
                    staticStyle: {
                        display: "none"
                    }
                    ...
                    class: {
                        disabled: 0 === e.selectedUsersCount || 0 === e.name.length || 0 === e.recipients.length
                    },
                    on: {
                        click: function(t) {
                    ...
                    on: {
                        click: function(t) {
                            e.isSaved ? (e.setDisplayEdit(!1), e.setCloseAction(!1)) : e.setCloseAction(!0)
                        }
                    }
                }, [e._v("\n      Back\n    ")])])])
            },
            Ne = [function() {
                var e = this,
                    ...
                    s = e._self._c || t;
                return s("li", {
                    staticClass: "labels-dropdown-search"
        ...
        function Le(e) {
            for (var t = 1; t < arguments.length; t++) {
                var s = null != arguments[t] ? arguments[t] : {};
                t % 2 ? Pe(Object(s), !0).forEach((function(t) {
                    Object(f["a"])(e, t, s[t])
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(s)) : Pe(Object(s)).forEach((function(t) {
                    Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(s, t))
                }))
            }
            return e
        ...
        var Me = {
                ...
                computed: Le(Le({}, Object(w["c"])({
                    ...
                    usernamesIncludeFuture: {
                        get: function() {
                            return this.$store.getters[W.getters.GET_EDIT_INCLUDE_USERNAMES_FUTURE]
                        },
                        set: function(e) {
                            this.$store.commit(W.mutations.SET_EDIT_INCLUDE_USERNAMES_FUTURE, e)
                        }
                    },
                    optionalAttachment: {
                        get: function() {
                            return this.$store.getters[W.getters.GET_EDIT_OPTIONAL_ATTACHMENT]
                        },
                        set: function(e) {
                    ...
                    subaccountsIncludeFuture: {
                        get: function() {
                            return this.$store.getters[W.getters.GET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE]
                        },
                        set: function(e) {
                            this.$store.commit(W.mutations.SET_EDIT_INCLUDE_SUBACCOUNTS_FUTURE, e)
                        }
                    },
                    ...
                    editEvents: function() {
                        return "activity" == this.selectedOrigin ? this.selectedActivityEvents : "suppressions" == this.selectedOrigin ? this.selectedSuppressionEvents : null
                    },
                    ...
                    overallUsersCheckboxState: function() {
                        var e = [].concat(Object(Ge["a"])(this.smtpUsers), Object(Ge["a"])(this.ipUsers), Object(Ge["a"])(this.apiUsers)),
                            t = this.selectedSubaccounts,
                            s = e.length > 0 && e.every((function(e) {
                                return e.checked
                            })),
                            i = t.every((function(e) {
                                return e.checked
                            }));
                        return s && i ? "checked" : e.some((function(e) {
                            return e.checked
                        })) || t.some((function(e) {
                            return e.checked
                        })) ? "indeterminate" : ""
                    ...
                    allSubaccountsChecked: function() {
                        return this.selectedSubaccounts.length > 1 && this.selectedSubaccounts.every((function(e) {
                            return e.checked
                        }))
                    },
                    ...
                    eventsCheckboxState: function() {
                        var e = !0,
                            t = !0;
                        return "activity" == this.selectedOrigin ? this.selectedActivityEvents.forEach((function(s) {
                            s.checked ? t = !1 : e = !1
                        })) : "suppressions" == this.selectedOrigin && this.selectedSuppressionEvents.forEach((function(s) {
                            s.checked ? t = !1 : e = !1
                        })), e ? "checked" : t ? "" : "indeterminate"
                    },
                    subaccountsLabel: function() {
                        return this.selectedSubaccounts.length > 1 ? "Subaccounts and users" : "Users"
                    },
                    selectedSubaccountsList: function() {
                        return this.selectedSubaccounts.filter((function(e) {
                            return e.checked
                        })).map((function(e) {
                            return e.record_id
                        }))
                    ...
                    checkedSmtpUsers: function() {
                        var e = this,
                            t = this.selectedUsernames.filter((function(t) {
                                return t.checked && !e.smtpRegex.test(t.username) && e.selectedSubaccountsList.includes(t.owner)
                            }));
                        return t
                    },
                    checkedIpUsers: function() {
                        var e = this;
                        return this.selectedUsernames.filter((function(t) {
                            return t.checked && e.ipRegex.test(t.username) && e.selectedSubaccountsList.includes(t.owner)
                        }))
                    },
                    checkedApiUsers: function() {
                        var e = this;
                        return this.selectedUsernames.filter((function(t) {
                            return t.checked && e.apiRegex.test(t.username) && e.selectedSubaccountsList.includes(t.owner)
                        }))
                    },
                    smtpUsersCheckboxState: function() {
                        return 0 == this.checkedSmtpUsers.length ? "" : this.checkedSmtpUsers.length == this.smtpUsers.length ? "checked" : "indeterminate"
                    },
                    ipsCheckboxState: function() {
                        return 0 == this.checkedIpUsers.length ? "" : this.checkedIpUsers.length == this.ipUsers.length ? "checked" : "indeterminate"
                    },
                    apiKeysCheckboxState: function() {
                        return 0 == this.checkedApiUsers.length ? "" : this.checkedApiUsers.length == this.apiUsers.length ? "checked" : "indeterminate"
                    },
                    subaccountsCheckboxState: function() {
                        var e = this.selectedSubaccounts.filter((function(e) {
                            return e.checked
                        }));
                        return 0 == e.length ? "" : e.length == this.subaccounts.length ? "checked" : "indeterminate"
                    },
                    userSelectionText: function() {
                        var e = this.smtpUsers.length + this.ipUsers.length + this.apiUsers.length,
                            t = this.selectedUsersCount,
                            s = t === e;
                        return 0 === t ? "No users selected" : s ? "All users selected" : 1 === t ? "1 user selected" : "".concat(t, " users selected")
                    },
                    subaccountSelectionText: function() {
                        ...
                        return 0 === e ? "No subaccounts selected" : t ? "All subaccounts selected" : 1 === e ? "1 subaccount selected" : "".concat(e, " subaccounts selected")
                    },
                    summaryGroupByActiveOptions: function() {
                        return this.subaccounts.length <= 1 ? this.summaryGroupByOptions.filter((function(e) {
                            return "subaccount" !== e.value
                        })) : this.summaryGroupByOptions
                    }
                }),
                methods: Le(Le({}, Object(w["d"])({
                    toggleEditActivityEvent: W.mutations.TOGGLE_EDIT_ACTIVITY_EVENT,
                    toggleEditSuppressionEvent: W.mutations.TOGGLE_EDIT_SUPPRESSION_EVENT,
                    ...
                    addRecipient: function(e) {
                        this.pushEditRecipients(e), this.recipientsDropdownActive = !1
                    },
                    removeRecipient: function(e) {
                        this.removeEditRecipients(e, 1)
                    },
                    toggleDropdown: function(e) {
                        this.eventsDropdownActive = !this.eventsDropdownActive, e.stopPropagation()
                    },
                    toggleRecipientsDropdown: function(e) {
                        this.recipientsDropdownActive = !this.recipientsDropdownActive, e.stopPropagation()
                    },
                    toggleSubaccountsDropdown: function(e) {
                        this.subaccountsDropdownActive = !this.subaccountsDropdownActive, e.stopPropagation()
                    },
                    toggleUsersDropdown: function(e) {
                        this.usersDropdownActive = !this.usersDropdownActive, e.stopPropagation()
                    },
                    handleClickInsideDropdown: function() {
                        var e = this;
                        this.clickedWithinDropdown = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            e.ignoreFocusOut = !1
                        }), 200)
                    },
                    ...
                    handleClickInsideSubaccountsDropdown: function() {
                        var e = this;
                        this.clickedWithinSubaccountsDropdown = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            e.ignoreFocusOut = !1
                        }), 200)
                    },
                    handleClickInsideUsersDropdown: function() {
                        var e = this;
                        this.clickedWithinUsersDropdown = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            e.ignoreFocusOut = !1
                        }), 200)
                    },
                    handleClickOutsideDropdowns: function(e) {
                        this.ignoreFocusOut || (!this.clickedWithinDropdown && this.eventsDropdownActive && this.$el.querySelector(".labels-dropdown") && !this.$el.querySelector(".labels-dropdown").contains(e.target) && (this.eventsDropdownActive = !1), !this.clickedWithinDropdown && this.recipientsDropdownActive && this.$el.querySelector(".labels-dropdown") && !this.$el.querySelector(".labels-dropdown").contains(e.target) && (this.recipientsDropdownActive = !1), !this.clickedWithinSubaccountsDropdown && this.subaccountsDropdownActive && this.$el.querySelector(".labels-dropdown") && !this.$el.querySelector(".labels-dropdown").contains(e.target) && (this.subaccountsDropdownActive = !1), !this.clickedWithinUsersDropdown && this.usersDropdownActive && this.$el.querySelector(".labels-dropdown") && !this.$el.querySelector(".labels-dropdown").contains(e.target) && (this.usersDropdownActive = !1), this.clickedWithinDropdown = !1)
                    },
                    updateSchedule: function() {
                        var e = this,
                            t = W.actions.UPDATE_SCHEDULE;
                        this.isCreate && (t = W.actions.CREATE_SCHEDULE), this.$store.dispatch(t).then((function() {
                            e.$eventBus.$emit("mixin-search-has-changed"), e.$eventBus.$emit("mixin-search-trigger"), e.setDisplayEdit(!1), e.setIsSaved(!0)
                        }))
                    },
                    handleDropdownFocusOut: function(e) {
                        var t = this;
                        this.ignoreFocusOut || setTimeout((function() {
                            var s;
                            s = "event" === e ? t.$refs.eventsDropdownContainer : "subaccount" === e ? t.$refs.subaccountsDropdownContainer : "user" === e ? t.$refs.usersDropdownContainer : t.$refs.recipientsDropdownContainer, s && !s.contains(document.activeElement) && ("event" === e ? t.eventsDropdownActive = !1 : "subaccount" === e ? t.subaccountsDropdownActive = !1 : "user" === e ? t.usersDropdownActive = !1 : t.recipientsDropdownActive = !1)
                        }), 100)
                    },
                    openDropdown: function(e) {
                        "event" === e ? (this.eventsDropdownActive = !0, this.currentEventIndex = 0) : "subaccount" === e ? (this.subaccountsDropdownActive = !0, this.currentEventIndex = 0) : "user" === e ? (this.usersDropdownActive = !0, this.currentEventIndex = 0) : (this.recipientsDropdownActive = !0, this.currentEventIndex = 0)
                    },
                    ...
                    toggleAllEvents: function() {
                        var e = this;
                        "activity" == this.selectedOrigin ? this.toggleEditActivityEvent() : "suppressions" == this.selectedOrigin && this.toggleEditSuppressionEvent(), this.eventsDropdownActive = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            e.ignoreFocusOut = !1
                        }), 200)
                    },
                    toggleEvent: function(e) {
                        var t = this;
                        "activity" == this.selectedOrigin ? this.toggleEditActivityEvent(e) : "suppressions" == this.selectedOrigin && this.toggleEditSuppressionEvent(e), this.eventsDropdownActive = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            t.ignoreFocusOut = !1
                        }), 200)
                    },
                    toggleEventDelete: function(e) {
                        var t = this;
                        "activity" == this.selectedOrigin ? this.toggleEditActivityEvent(e) : "suppressions" == this.selectedOrigin && this.toggleEditSuppressionEvent(e), this.ignoreFocusOut = !0, setTimeout((function() {
                            t.ignoreFocusOut = !1
                        }), 200)
                    },
                    toggleUsername: function(e) {
                        var t = this;
                        this.toggleEditUsername(e), this.usersDropdownActive = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            t.ignoreFocusOut = !1
                        }), 200), this.adjustDropdownHotspotHeight("usersDropdownContainer")
                    },
                    toggleAllSmtpUsers: function() {
                        var e = this;
                        this.toggleEditSmtpUsers(), this.usersDropdownActive = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            e.ignoreFocusOut = !1
                        }), 200), this.adjustDropdownHotspotHeight("usersDropdownContainer")
                    },
                    toggleAllIpUsers: function() {
                        var e = this;
                        this.toggleEditIpUsers(), this.usersDropdownActive = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            e.ignoreFocusOut = !1
                        }), 200), this.adjustDropdownHotspotHeight("usersDropdownContainer")
                    },
                    toggleAllApiUsers: function() {
                        var e = this;
                        this.toggleEditApiUsers(), this.usersDropdownActive = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            e.ignoreFocusOut = !1
                        }), 200), this.adjustDropdownHotspotHeight("usersDropdownContainer")
                    },
                    toggleAllUsers: function() {
                        ...
                        this.selectedSubaccounts.forEach((function(s) {
                            s.checked !== t && e.toggleEditSubaccount(Le(Le({}, s), {}, {
                                checked: t
                            }))
                        }));
                        var s = [].concat(Object(Ge["a"])(this.smtpUsers), Object(Ge["a"])(this.ipUsers), Object(Ge["a"])(this.apiUsers));
                        s.forEach((function(s) {
                            s.checked !== t && e.toggleEditUsername(Le(Le({}, s), {}, {
                                checked: t
                            }))
                        })), this.usersDropdownActive = !0, this.ignoreFocusOut = !0, setTimeout((function() {
                            e.ignoreFocusOut = !1
                        }), 200), this.adjustDropdownHotspotHeight("usersDropdownContainer")
                    },
                    toggleSubaccount: function(e) {
                        var t = this;
                        console.log("Current state:", e.checked), this.usersDropdownActive = !0;
                        var s = !e.checked;
                        this.toggleEditSubaccount(Le(Le({}, e), {}, {
                            checked: s
                        }));
                        var i = [].concat(Object(Ge["a"])(this.smtpUsersFiltered(e.record_id)), Object(Ge["a"])(this.ipUsersFiltered(e.record_id)), Object(Ge["a"])(this.apiUsersFiltered(e.record_id)));
                        console.log("Total users:", i.length), console.log("All users selected before toggle:", i.every((function(e) {
                            return e.checked
                        }))), console.log("Target state:", s), i.forEach((function(e) {
                            e.checked !== s && t.toggleEditUsername(Le(Le({}, e), {}, {
                                checked: s
                            }))
                        })), e.checked !== s && this.toggleEditSubaccount(Le(Le({}, e), {}, {
                            checked: s
                        })), this.ignoreFocusOut = !0, setTimeout((function() {
                            t.ignoreFocusOut = !1
                        }), 200), this.adjustDropdownHotspotHeight("subaccountsDropdownContainer")
                    },
                    subaccountCheckboxState: function(e) {
                        var t = [].concat(Object(Ge["a"])(this.smtpUsersFiltered(e.record_id)), Object(Ge["a"])(this.ipUsersFiltered(e.record_id)), Object(Ge["a"])(this.apiUsersFiltered(e.record_id)));
                        ...
                        this.$nextTick((function() {
                            ...
                            if (s) {
                                ...
                                if (i) {
                                    ...
                                    o && (o.style.height = a), r > 206 ? "usersDropdownContainer" === e ? t.usersCaretFixedScrollPush = !0 : "subaccountsDropdownContainer" === e && (t.subaccountsCaretFixedScrollPush = !0) : "usersDropdownContainer" === e ? t.usersCaretFixedScrollPush = !1 : "subaccountsDropdownContainer" === e && (t.subaccountsCaretFixedScrollPush = !1), i.style.maxHeight = n
                                }
                            }
                        }))
                    },
                ...
                watch: {
                    isFocused: function(e) {
                        e ? window.addEventListener("keydown", this.preventArrowKeyScroll, !1) : window.removeEventListener("keydown", this.preventArrowKeyScroll, !1)
                    },
                ...
                mounted: function() {
                    document.addEventListener("click", this.handleClickOutsideDropdowns), this.adjustDropdownHotspotHeight("usersDropdownContainer"), this.adjustDropdownHotspotHeight("subaccountsDropdownContainer")
                },
                beforeDestroy: function() {
                    window.removeEventListener("keydown", this.preventArrowKeyScroll, !1), document.removeEventListener("click", this.handleClickOutsideDropdowns)
                }
            },
            $e = Me,
            ...
            He = function() {
                var e = this,
                    t = e.$createElement,
                    s = e._self._c || t;
                return e.shouldShow || e.isAjaxActive ? s("div", {
                    staticClass: "loading"
                }, [e._m(0), s("div", {
        ...
        function Ve(e) {
            for (var t = 1; t < arguments.length; t++) {
                var s = null != arguments[t] ? arguments[t] : {};
                t % 2 ? qe(Object(s), !0).forEach((function(t) {
                    Object(f["a"])(e, t, s[t])
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(s)) : qe(Object(s)).forEach((function(t) {
                    Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(s, t))
                }))
            }
            return e
        ...
        var ze = {
                ...
                computed: Ve(Ve({}, Object(w["c"])({
                    isAjaxActive: P.getters.GET_IS_AJAX_RUNNING
                })), {}, {
                    shouldShow: function() {
            ...
            Xe = function() {
                ...
                return s("div", [s("div", {
                ...
                }, [e._v(e._s(e.successMessage))]), s("span", {
                    ...
                    staticClass: "notice-message-text"
                }, [e._v(e._s(e.errorMessage))]), s("span", {
                    staticClass: "button-close",
                    on: {
                        click: function(t) {
        ...
        function et(e) {
            for (var t = 1; t < arguments.length; t++) {
                var s = null != arguments[t] ? arguments[t] : {};
                t % 2 ? Ze(Object(s), !0).forEach((function(t) {
                    Object(f["a"])(e, t, s[t])
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(s)) : Ze(Object(s)).forEach((function(t) {
                    Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(s, t))
                }))
            }
            return e
        ...
        var ot = {
                ...
                created: function() {
                    this.mixinEventListener_register(Object(f["a"])({}, g.TRIGGERABLE_CLOSED, this.checkClosed)), this.mixinEventListener_on()
                },
                destroyed: function() {
                    this.mixinEventListener_off()
                },
                computed: at(at({}, Object(w["c"])({
                    isSaved: W.getters.GET_IS_SAVED,
                    isCreate: W.getters.GET_IS_CREATE,
                ...
                methods: at(at(at({}, Object(w["d"])({
                    ...
                    fetchUsernames: W.actions.FETCH_USERNAMES
                })), {}, {
                    addReport: function() {
                        this.setEditId(""), this.setEditOrigin("summary"), this.setEditSummaryGroupBy("auth"), this.setEditName(""), this.setEditEvents(), this.setEditUsernames(), this.setEditSubaccounts(), this.setEditFrequency("1 day"), this.setEditDatatype("csv"), this.setEditRecipients(), this.setIsSaved(!0), this.setIsCreate(!0), this.setIsAdd(!0), this.setDisplayEdit(!0), this.setIncludeUsernamesFuture(!0), this.setIncludeSubaccountsFuture(!0)
                    },
                    initDataExports: function(e) {
                        this.id = e, setTimeout(this.holdInit, 100)
                    },
                    holdInit: function() {
                        this.initialised || void 0 == HTML.csrfkey || (this.initComponents(), this.loadDataExports(), this.fetchUsernames())
                    },
                    initComponents: function() {
                        this.$refs.dataExportsResultsDisplay.initDataExportsResultsDisplay(this.id)
                    },
                    ...
                    closeEdit: function() {
                        this.isSaved ? (this.setDisplayEdit(!1), this.setCloseAction(!1)) : this.setCloseAction(!0)
                    },
                    buildSearchPayload: function() {
                        var e = {
                            client_timezone: this.clientTimezone ? this.clientTimezone : y.a.tz.guess()
                        };
                        return e
                    },
                    updateDataExportsData: function() {
                        this.$refs.dataExportsResultsDisplay.updateDataExportsResults(this.tableRows, this.hasLongDate), this.$refs.scheduledResultsDisplay.updateScheuldedResults(this.scheduledTableRows), this.$refs.scheduledEdit.adjustDropdownHotspotHeight("usersDropdownContainer"), this.$refs.scheduledEdit.adjustDropdownHotspotHeight("subaccountsDropdownContainer")
                    },
                    performSearch: function(e, t) {
                        var s = this;
                        this.fullPageLoad = !1, t || (this.clearTableOnResults = !0, window.scroll({
                            top: 0,
                            left: 0,
                            behavior: "smooth"
                        }), this.fullPageLoad = !0), this.mixinAjax_get(this.requestPoint, "", this.buildSearchPayload(t), (function(t) {
                            s.handleTableResults(t.responseJSON.results), e && (s.initialised = !0), s.updateDataExportsData()
                        }), (function(e) {
                            HTML.handleError(e.responseJSON)
                        }))
                    },
                    handleTableResults: function(e) {
                        this.tableRows = [], void 0 === e.client_timezone || null === e.client_timezone || "" === e.client_timezone ? this.clientTimezone = y.a.tz.guess() : this.clientTimezone = e.client_timezone, this.tableRows = this.formatToDisplay(e.exports), this.tableRows.sort((function(e, t) {
                            return t.added.unix_secs_ms - e.added.unix_secs_ms
                        })), this.scheduledTableRows = e.scheduled_data_exports, this.setActiveMembers(e.active_members), this.setActiveMemberNames(e.active_member_names), this.setAllowScheduledExport(e.allow_scheduled_export), this.setUsername(e.username), this.setCanDeleteAny(e.can_delete_any), this.setActingRoleLevel(e.acting_role_label), this.setHidePaymentSplash(e.hide_payment_splash)
                    },
                    formatToDisplay: function(e) {
                        var t = this;
                        return this.hasLongDate = !1, e.forEach((function(e) {
                            e.date = t.formatDate(e), e.byte = t.formatFileSize(e), e.format = t.formatFileType(e.datatype), e.description = t.formatDescription(e)
                        })), e
                    },
                    formatDate: function(e) {
                        ...
                        return s.time = i.slice(i.indexOf(" ") + 1), s.timeClass = "time-large", t.is_before_lunchtime_yesterday && (this.hasLongDate = !0, s.date = i.slice(0, i.indexOf(" ")), s.timeClass = "time"), s
                    },
                    formatFileSize: function(e) {
                        ...
                        return 0 === i ? t + " " + s[i] : (t / Math.pow(1024, i)).toFixed(1) + " " + s[i]
                    },
                    formatFileType: function(e) {
                        return "json" === e ? "NDJSON" : "xls" === e ? "XLSX" : e.toUpperCase()
                    },
                    formatDescription: function(e) {
                        if (!e.completed && !e.failed) return "tar" === e.datatype || "zip" === e.datatype ? e.description + " - Queued" : e.description;
                        if (e.failed) return e.description + " - An unexpected error occurred";
                        var t = e.description + " - ";
                        return t += e.truncated ? "first " : "", t += HTML.format_number(e.row_count) + " results", t
                    },
                    saveSchedule: function() {
                        var e = this,
                            t = W.actions.UPDATE_SCHEDULE;
                        this.isCreate && (t = W.actions.CREATE_SCHEDULE), this.$store.dispatch(t).then((function() {
                            e.$eventBus.$emit("mixin-search-has-changed"), e.$eventBus.$emit("mixin-search-trigger"), e.setDisplayEdit(!1), e.setIsSaved(!0), e.setCloseAction(!1)
                        }))
                    }
                })
            },
            ...
            dt = {
                ...
                mounted: function() {
                    this.$refs.dataExports.initDataExports(this.id), document.body.classList.add("page-data-exports")
                },
                created: function() {
                    var e = this;
        ...
        var ht = new w["a"].Store({
            ...
            ft = s("24ab"),
            vt = s("e37d");
        r["a"].directive("tooltip", vt["c"]), r["a"].directive("close-popover", vt["a"]), r["a"].component("v-popover", vt["b"]), r["a"].config.productionTip = !1, r["a"].prototype.$eventBus = new r["a"], r["a"].prototype.$config = ft, "undefined" !== typeof PAGE_DATA && mt.commit(P.mutations.SET_CSRF_KEY, PAGE_DATA.csrfkey), "undefined" !== typeof IMAGE_URLS && mt.commit(P.mutations.SET_IMAGE_URLS, IMAGE_URLS), "undefined" !== typeof END_POINTS && mt.commit(P.mutations.SET_END_POINTS, END_POINTS.urls()), z(mt), new r["a"]({
            store: mt,
            render: function(e) {
                return e(pt)
            }
